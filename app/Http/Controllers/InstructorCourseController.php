...
class InstructorCourseController extends Controller
{
    ...
    public function courseCreate_process(Request $request) {
        ...
        if($instructor->status !== 'Approved') {
            ...
            try {
                ...
                $action = "Created New Course ID: " .  $course->course_id; 
                $this->log($action);
    ...
    public function courseCreateUploadFiles(Course $course, Request $request) {
        ...
        $action = "Uploaded Files in Course ID: ". $course->course_id;
        $this->log($action);
    ...
    public function overview(Course $course){
        if (session()->has('instructor')) {
            ...
            $action = "Opened Course ID: ". $course->course_id;
            $this->log($action);
    ...
    public function editCourseDetails(Course $course, Request $request) {
        if (session()->has('instructor')) {
            ...
            try{
                ...
                $action = "Updated Details, Course ID: " . $course->course_id;
                $this->log($action);
    ...
    public function add_file(Course $course, Request $request)
    {
        ...
        $action = "Updated Course Files, Course ID: " . $course->course_id;
        $this->log($action);
    ...
    public function delete_course(Course $course) {
        ...
        try {
            ...
            $action = "Deleted Course, Course ID: " . $course->course_id;
            $this->log($action);
        ...
        try {
            ...
            if ($syllabusData['category'] == 'LESSON') {
                ...
                Lessons::updateOrCreate(
                    ['syllabus_id' => $syllabus->syllabus_id, 'course_id' => $course->course_id],
                    $lessonData
                );
            ...
            $action = "Updated Course Syllabus, Course ID: " . $course->course_id;
            $this->log($action);
    ...
    public function view_lesson(Course $course, Syllabus $syllabus) {
        ...
        if (session()->has('instructor')) {
            ...
            if($instructor->status !== 'Approved') {
                ...
                try {
                    ...
                    $action = "View Lesson ID: ". $syllabus->syllabus_id ." Course ID: " . $course->course_id;
                    $this->log($action);
    ...
    public function lesson_content_json (Course $course, Syllabus $syllabus) {
        if (session()->has('instructor')) {
            $instructor = session('instructor');
    ...
    public function addCompletionTime(Course $course, Syllabus $syllabus, Request $request) {
        try {
    ...
    public function update_lesson_title(Course $course, Syllabus $syllabus, $lesson_id, Request $request) {
        try {
    ...
    public function update_lesson_picture(Course $course, Syllabus $syllabus, Lessons $lesson, Request $request) {
        try {
    ...
    public function save_lesson_content(Course $course, Syllabus $syllabus, Lessons $lesson, Request $request) {
        try {



            $lessonContentID = $request->input('lesson_content_id');

            DB::table('lesson_content')
            ->where('lesson_content_id', $lessonContentID)
            ->update([
                'lesson_content_id' => $request->input('lesson_content_id'),
                'lesson_content_title' => $request->input('lesson_content_title'),
                'lesson_content' => $request->input('lesson_content'),
                'lesson_content_order' => $request->input('lesson_content_order'),
            ]);
            ...
            return response()->json(['message' => 'Lesson Content updated successfully', 'redirect_url' => "/instructor/course/content/$course->course_id/$syllabus->syllabus_id/lesson"]);
    ...
    public function save_add_lesson_content(Course $course, Syllabus $syllabus, Lessons $lesson, Request $request) {
    ...
    public function lesson_content_delete_file(Course $course, Syllabus $syllabus, Lessons $lesson, LessonContents $lesson_content) {
        try {
    ...
    public function lesson_content_embed_url(Course $course, Syllabus $syllabus, Lessons $lesson, LessonContents $lesson_content, Request $request) {
        try {
    ...
    public function lesson_content_delete_url (Course $course, Syllabus $syllabus, Lessons $lesson, LessonContents $lesson_content) {
        try {
            $updatedRow = [
                'video_url' => null
            ];
    ...
    public function view_lesson_pdf(Course $course, Syllabus $syllabus) {
...
public function lesson_generate_pdf(Course $course, Syllabus $syllabus, Lessons $lesson)
{
    if (session()->has('instructor')) {
        $instructor = session('instructor');
    ...
    // for course activity
    public function view_activity(Course $course, Syllabus $syllabus) {
        if (session()->has('instructor')) {
            $instructor = session('instructor');
            ...
            // if ($activityContent->isNotEmpty()) {
                ...
                if (!$activityContentCriteria) {
                    $newActivityContentCriteria = [
                        'activity_content_id' => $activityContent->activity_content_id,
    ...
    public function activity_content_json(Course $course, Syllabus $syllabus) {
        if (session()->has('instructor')) {
            $instructor = session('instructor');
    ...
    public function update_activity_instructions(Course $course, Syllabus $syllabus, Activities $activity, ActivityContents $activity_content, Request $request) {
        try {
            $updated_values = $request->validate([
    ...
    public function update_activity_score(Course $course, Syllabus $syllabus, Activities $activity, ActivityContents $activity_content, Request $request) {
        try {
            $updated_values = $request->validate([
    ...
    public function update_activity_criteria(Course $course, Syllabus $syllabus, Activities $activity, ActivityContents $activity_content, Request $request) {
        try {
    ...
    public function add_activity_criteria(Course $course, Syllabus $syllabus, Activities $activity, ActivityContents $activity_content, Request $request) {
        try {
            $updated_criterias = $request->validate([
                'activity_content_id' => ['required'],
                'criteria_title' => ['required'],
    ...
    public function view_learner_activity_response(Course $course, Syllabus $syllabus, LearnerCourse $learner_course, $attempt) {
        if (session()->has('instructor')) {
            $instructor = session('instructor');
    ...
    public function learnerResponse_overallScore($learner_activity_output, $learner_course, $activity, $activity_content, $attempt, Request $request) {
        if (session()->has('instructor')) {
            ...
            DB::table('learner_activity_progress')
                ...
                $action = "Updated Score on Learner ID, ". $learnerActivityOutputData->learner_course_id ."  Activity ID: ". $learnerActivityOutputData->syllabus_id ." Course ID: " . $learnerActivityOutputData->course_id;
                $this->log($action);
            ...
            if ($learnerActivityOutputData_2nd) {
                ...
                if ($learnerActivityOutputData->total_score !== null && $learnerActivityOutputData->mark) {
                    ...
                    if ($existingAttempt2Data) {
                        ...
                        $action = "Allow Reattempt on Learner ID, ". $learner_course ."  Activity ID: ". $activityData->syllabus_id ." Course ID: " . $activityData->course_id;
                        $this->log($action);
    ...
    public function view_quiz(Course $course, Syllabus $syllabus) {
        if (session()->has('instructor')) {
            $instructor = session('instructor');
            ...
            if($instructor->status !== 'Approved') {
                ...
                $action = "View Quiz ID: ". $syllabus->syllabus_id ." Course ID: " . $course->course_id;
                $this->log($action);
    ...
    public function quiz_info_json (Course $course, Syllabus $syllabus) {
        if (session()->has('instructor')) {
            $instructor = session('instructor');
    ...
    public function manage_add_reference (Course $course, Syllabus $syllabus, Quizzes $quiz, Request $request) {
        try {
    ...
    public function manage_update_reference (Course $course, Syllabus $syllabus, Quizzes $quiz, Request $request) {
        try {
            $newReference = $request->validate([
                'quiz_id' => ['required'],
                'course_id' => ['required'],
    ...
    public function manage_update_duration(Course $course, Syllabus $syllabus, Quizzes $quiz, Request $request) {
    ...
    public function quiz_content (Course $course, Syllabus $syllabus, Quizzes $quiz) {
        if (session()->has('instructor')) {
            $instructor = session('instructor');
    ...
    public function quiz_content_json (Course $course, Syllabus $syllabus, Quizzes $quiz) {
        if (session()->has('instructor')) {
            $instructor = session('instructor');
...
$questionsData = DB::table('questions')
    ...
    public function empty_quiz_question(Course $course, Syllabus $syllabus, $quiz_id)
    {
        try {
            DB::beginTransaction();
    ...
    public function view_learner_output(Course $course, Syllabus $syllabus, LearnerQuizProgress $learner_quiz_progress) {
    ...
    public function view_learner_output_json(Course $course, Syllabus $syllabus, LearnerQuizProgress $learner_quiz_progress) {
        ...
        if (session()->has('instructor')) {
            ...
            try {
                ...
                if($courseData->course_status === 'Approved') {
                    ...
                    $action = "Generated Certificated on Course ID: " . $course->course_id;
                    $this->log($action);
