...
public function get_learner_pdf_files($directory){
    ...
    foreach ($subDirectories as $subDirectory) {
        $pdfFiles = array_merge($pdfFiles, $this->get_learner_pdf_files($subDirectory));
    }
...
public function get_learner_course_pdf_files($directory){
    ...
    foreach ($subDirectories as $subDirectory) {
        $pdfFiles = array_merge($pdfFiles, $this->get_learner_course_pdf_files($subDirectory));
    }
