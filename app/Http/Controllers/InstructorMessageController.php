        ...
        try{
            ...
            foreach($emailToReceive as $email) {
                $messageData = Message::create([
                    ...
                    'sender_user_type' => 'Instructor',
                    'sender_user_email' => $instructor->instructor_email,
    ...
    public function getMessages(Request $request) {
            ...
            try{
                ...
                END AS receiver_profile_picture'),
                    ...
                    ->where(function($query) use ($instructor, $searchVal) {
                        $query->where('message.sender_user_email', $instructor->instructor_email)
                            ->orWhere('message.receiver_user_email', $instructor->instructor_email)
    ...
    public function reply(Request $request) {
        ...
        try{
            ...
            $messageReply = MessageReply::create([
                ...
                'reply_user_email' => $instructor->instructor_email,
                'date_sent' => $timestampString
            ]);
