            ...
            <div class="">
                <div class="flex flex-row items-center justify-between px-4">
                    ...
                    <button class="hidden w-8 h-8 rounded bg-seagreen lg:block">
                        <svg class="mx-auto fill-white" xmlns="http://www.w3.org/2000/svg" height="24"
                ...
                <div class="mt-4 text-center text-mainwhitebg md:hidden">
                    <form action="">
                        <button
                            class="w-32 h-10 font-medium underline rounded-lg shadow-lg underline-offset-2 bg-darthmouthgreen">Logout</button>
                    </form>
                </div>
            </div>
        </div>
