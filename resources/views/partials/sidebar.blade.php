<section class="fixed z-20 w-auto h-auto overflow-hidden md:w-full lg:w-2/12 md:relative text-txtclr" id="sidebar_full">
    <div class="fixed flex flex-col justify-between w-full overflow-y-hidden bg-primary hover:overflow-y-auto md:h-screen md:relative lg:border-r-4 border-darthmouthgreen"
        ...
        <div class="">
            <div class="flex justify-between p-3">
                ...
                <div class="w-full md:block" id="logo_full">
                    <a href="{{ url('/admin/dashboard') }}">
                        <!--         {{-- <span class="self-center text-lg font-semibold text-darthmouthgreen font-semibbold whitespace-nowrap md:text-2xl">
                            Eskwela4EveryJuan
                        </span> --}}-->

                        <img class="hidden h-16 md:block" src="{{ asset('storage/images/e4ej_logo-landscape.svg')}}"
                            alt="">

                        <img class="size-8 md:hidden" src="{{ asset('storage/images/e4ej_logo_icon.svg')}}" alt="">
            ...
            <ul class="flex-row justify-between hidden mt-10 md:flex md:flex-col md:text-base">
                <li id="" class="w-full py-3 rounded-lg dashboardSideBtn instructor_dashboard group">
                    <a class="flex items-center justify-center md:justify-start md:px-2"
                        href="{{ url('/admin/dashboard')}}">
                        <svg class="mx-3 duration-500 stroke-txtclr group-hover:stroke-white group-hover:animate-bounce"
                ...
                <li id="" class="w-full py-3 rounded-lg instructor_courses group">
                    <a class="flex items-center justify-center md:justify-start md:px-2"
                        href="{{ url('/admin/learners') }}">

                        <i
                            class="mx-3 duration-500 p-1 w-[25px] h-[25px] stroke-txtclr fa-regular fa-user group-hover:stroke-white group-hover:animate-bounce"></i>
                ...
                <li id="" class="w-full py-3 rounded-lg instructor_courses group">
                    <a class="flex items-center justify-center md:justify-start md:px-2"
                        ...
                        <svg class="mx-3 duration-500 fill-txtclr group-hover:fill-white group-hover:animate-bounce"
                            width="25" height="25" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <li id="" class="w-full py-3 rounded-lg instructor_courses group">
                    <a class="flex items-center justify-center md:justify-start md:px-2"
                        href="{{ url('/admin/courseManage') }}">

                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="mx-3 duration-500 stroke-txtclr group-hover:stroke-white group-hover:animate-bounce"
                            width="25" height="25" viewBox="0 0 27 27" fill="none" stroke="#000000" stroke-width="2"
                ...
                <li id="" class="w-full py-3 rounded-lg instructor_courses group">
                    <a class="flex items-center justify-center md:justify-start md:px-2"
                        href="{{ url('/admin/course/enrollment') }}">
                        ...
                        <svg class="mx-3 duration-500 stroke-txtclr group-hover:stroke-white group-hover:animate-bounce"
                            ...
                            <path
                                d="M18 10L22 12V20C22 20.5304 21.7893 21.0391 21.4142 21.4142C21.0391 21.7893 20.5304 22 20 22H4C3.46957 22 2.96086 21.7893 2.58579 21.4142C2.21071 21.0391 2 20.5304 2 20V12L6 10M18 5V22M4 6L12 2L20 6M6 5V22"
                                stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            <path
                ...
                <li id="" class="w-full py-3 rounded-lg instructor_courses group">
                    <a class="flex items-center justify-center md:justify-start md:px-2"
                        ...
                        <i
                            class="mx-3 w-[25px] h-[25px] p-1 duration-500 fa-regular fa-message group-hover:fill-white group-hover:animate-bounce"></i>

                        <h1 class="hidden md:block group-hover:text-white">Message</h1>
                    </a>
                </li>

                <li id="" class="w-full py-3 rounded-lg instructor_performances group">
                    <a class="flex items-center justify-center md:justify-start md:px-2" href="{{ url("/admin/performance") }}">
                ...
                <li id="" class="w-full py-3 rounded-lg instructor_performances group">
                    <a class="flex items-center justify-center md:justify-start md:px-2" href="{{ url("/admin/reports")
                        }}">

                        <svg class="mx-3 duration-500 stroke-txtclr group-hover:stroke-white group-hover:animate-bounce"
                            width="25" height="25" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M17 6.5L10.625 0.5H2.125C1.56141 0.5 1.02091 0.710714 0.622398 1.08579C0.223883 1.46086 0 1.96957 0 2.5V18.5C0 19.0304 0.223883 19.5391 0.622398 19.9142C1.02091 20.2893 1.56141 20.5 2.125 20.5H14.875C15.4386 20.5 15.9791 20.2893 16.3776 19.9142C16.7761 19.5391 17 19.0304 17 18.5V6.5ZM5.3125 17.5H3.1875V8.5H5.3125V17.5ZM9.5625 17.5H7.4375V11.5H9.5625V17.5ZM13.8125 17.5H11.6875V14.5H13.8125V17.5ZM10.625 7.5H9.5625V2.5L14.875 7.5H10.625Z" />
                        </svg>
                ...
                <div class="px-2 divider divider-secondary"></div>
                ...
                <li id="" class="w-full py-3 rounded-lg instructor_courses group">
                    <a class="flex items-center justify-center md:justify-start md:px-2"
                        ...
                        <svg class="mx-3 duration-500 fill-txtclr group-hover:fill-white group-hover:animate-bounce" 
                        width="25" height="25" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h1 class="hidden md:block group-hover:text-white">Activity Logs</h1>
                    </a>
                </li>
                @endif


                <li id="" class="w-full py-3 rounded-lg instructor_settings group">
                    <a class="flex items-center justify-center md:justify-start md:px-2"
                ...
                <form class="hidden px-3 py-6 rounded-lg md:block group " action="{{ url('/admin/logout') }}"
                    method="POST">
                    @csrf
        ...
        <div class="flex-row items-center justify-center hidden w-full py-4 md:flex hover:cursor-pointer"
            id="sidebar_half_btn">
    ...
    <div class="fixed flex flex-col justify-between px-2 border-r-4 bg-mainwhitebg md:h-screen md:pt-16 md:relative border-darthmouthgreen"
        ...
        <div class="">
            ...
            <ul class="flex flex-row justify-between mt-10 md:flex-col md:text-base">
                <li id=""
                    class="w-full py-3 rounded-lg dashboardSideBtn instructor_dashboard hover:bg-darthmouthgreen group md:py-4">
                ...
                <li id=""
                    ...
                    <a class="flex items-center justify-center md:justify-start md:px-4"
                        ...
                        <i
                            class="mx-3 text-xl text-gray-700 duration-500 fa-regular fa-user group-hover:fill-white group-hover:animate-bounce"></i>
                ...
                <li id=""
                    ...
                    <a class="flex items-center justify-center md:justify-start md:px-4"
                        ...
                        <svg class="mx-3 duration-500 group-hover:stroke-white group-hover:animate-bounce" width="25"
                ...
                <li id="" class="w-full py-3 rounded-lg instructor_courses hover:bg-darthmouthgreen group md:py-4">
                    <a class="flex items-center justify-center md:justify-start md:px-4"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="mx-3 duration-500 group-hover:fill-white group-hover:animate-bounce" width="27"
                            height="27" viewBox="0 0 27 27" fill="none" stroke="#000000" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path d="M22 10v6M2 10l10-5 10 5-10 5z" />
                            <path d="M6 12v5c3 3 9 3 12 0v-5" />
                        </svg>
                ...
                <li id=""
                    ...
                    <a class="flex items-center justify-center md:justify-start md:px-4"
                        ...
                        <svg class="mx-3 duration-500 group-hover:fill-white group-hover:animate-bounce" width="27"
                ...
                <li id=""
                    ...
                    <a class="flex items-center justify-center md:justify-start md:px-4"
                        ...
                        <i
                            class="mx-3 text-xl text-gray-700 duration-500 fa-regular fa-message group-hover:fill-white group-hover:animate-bounce"></i>
                ...
                <li id="" class="w-full py-3 rounded-lg instructor_performances hover:bg-darthmouthgreen group md:py-4">
                    <a class="flex items-center justify-center md:justify-start md:px-4" href="{{ url("/admin/reports")
                        }}">
                ...
                <li id=""
                    ...
                    <a class="flex items-center justify-center md:justify-start md:px-4"
                        ...
                        <svg class="mx-3 duration-500 group-hover:fill-white group-hover:stroke-white group-hover:animate-bounce"
                            width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M12 14V16C10.4087 16 8.88258 16.6321 7.75736 17.7574C6.63214 18.8826 6 20.4087 6 22H4C4 19.8783 4.84285 17.8434 6.34315 16.3431C7.84344 14.8429 9.87827 14 12 14ZM12 13C8.685 13 6 10.315 6 7C6 3.685 8.685 1 12 1C15.315 1 18 3.685 18 7C18 10.315 15.315 13 12 13ZM12 11C14.21 11 16 9.21 16 7C16 4.79 14.21 3 12 3C9.79 3 8 4.79 8 7C8 9.21 9.79 11 12 11ZM21 17H22V22H14V17H15V16C15 15.2044 15.3161 14.4413 15.8787 13.8787C16.4413 13.3161 17.2044 13 18 13C18.7956 13 19.5587 13.3161 20.1213 13.8787C20.6839 14.4413 21 15.2044 21 16V17ZM19 17V16C19 15.7348 18.8946 15.4804 18.7071 15.2929C18.5196 15.1054 18.2652 15 18 15C17.7348 15 17.4804 15.1054 17.2929 15.2929C17.1054 15.4804 17 15.7348 17 16V17H19Z"
                                fill="black" />
                ...
                <a class="flex items-center justify-center md:justify-start md:px-4"
                    ...
                    <svg class="mx-3 duration-500 fill-txtclr group-hover:fill-white group-hover:animate-bounce" 
                    width="25" height="25" viewBox="0 0 25 25" fill="none" version="1.1" xmlns="http://www.w3.org/2000/svg">
                        <path d="M0 24q0 0.832 0.576 1.44t1.44 0.576h1.984q0 2.496 1.76 4.224t4.256 1.76h6.688q-2.144-1.504-3.456-4h-3.232q-0.832 0-1.44-0.576t-0.576-1.408v-20q0-0.832 0.576-1.408t1.44-0.608h16q0.8 0 1.408 0.608t0.576 1.408v7.232q2.496 1.312 4 3.456v-10.688q0-2.496-1.76-4.256t-4.224-1.76h-16q-2.496 0-4.256 1.76t-1.76 4.256h-1.984q-0.832 0-1.44 0.576t-0.576 1.408 0.576 1.44 1.44 0.576h1.984v4h-1.984q-0.832 0-1.44 0.576t-0.576 1.408 0.576 1.44 1.44 0.576h1.984v4h-1.984q-0.832 0-1.44 0.576t-0.576 1.408zM10.016 24h2.080q0-0.064-0.032-0.416t-0.064-0.576 0.064-0.544 0.032-0.448h-2.080v1.984zM10.016 20h2.464q0.288-1.088 0.768-1.984h-3.232v1.984zM10.016 16h4.576q0.992-1.216 2.112-1.984h-6.688v1.984zM10.016 12h16v-1.984h-16v1.984zM10.016 8h16v-1.984h-16v1.984zM14.016 23.008q0 1.824 0.704 3.488t1.92 2.88 2.88 1.92 3.488 0.704 3.488-0.704 2.88-1.92 1.92-2.88 0.704-3.488-0.704-3.488-1.92-2.88-2.88-1.92-3.488-0.704-3.488 0.704-2.88 1.92-1.92 2.88-0.704 3.488zM18.016 23.008q0-2.080 1.44-3.52t3.552-1.472 3.52 1.472 1.472 3.52q0 2.080-1.472 3.52t-3.52 1.472-3.552-1.472-1.44-3.52zM22.016 23.008q0 0.416 0.288 0.704t0.704 0.288h1.984q0.416 0 0.704-0.288t0.32-0.704-0.32-0.704-0.704-0.288h-0.992v-0.992q0-0.416-0.288-0.704t-0.704-0.32-0.704 0.32-0.288 0.704v1.984z"></path>
                        </svg>
