        ...
        <div class="flex flex-col justify-between hidden h-full p-3 overflow-hidden rounded-lg shadow-lg mainchatbotarea">
            ...
            <div class="py-3 border-t-2 border-gray-300">
                ...
                <div class="flex items-center justify-between">
                    <textarea type="text" placeholder="Type here" class="w-full lg:w-4/5 question_input input input-bordered input-primary"></textarea>
...
<div class="fixed z-50 hidden w-full h-screen bg-white bg-opacity-60" id="sideprofile-sm">
    <div id="sp-container" class="fixed right-0 w-3/4 h-full bg-white">
        ...
        <div id="l-profile" class="w-full h-auto p-3 space-y-2 text-white bg-primary">
            ...
            src="{{ asset('storage/' . $learner->profile_picture) }}"
            alt="">
            <h2>{{$learner->learner_fname}} {{$learner->learner_lname}}</h2>
            <h3>{{$learner->learner_email}}</h3>
        </div>

        <form class="mt-10 rounded-lg bg-darthmouthgreen group hover:bg-white hover:border-2 hover:border-darthmouthgreen" action="{{ url('/learner/logout') }}" method="POST"> 
            @csrf
            <button type="submit" class="flex flex-row items-center justify-center w-full h-12 group-hover:cursor-pointer" >
                <svg class="flex-shrink-0 fill-white group-hover:fill-black" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h280v80H200v560h280v80H200Zm440-160-55-58 102-102H360v-80h327L585-622l55-58 200 200-200 200Z"/></svg>
                <h1 class="px-5 text-white group-hover:text-black">Logout</h1>
