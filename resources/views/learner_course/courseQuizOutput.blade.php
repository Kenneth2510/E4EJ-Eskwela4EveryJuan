    ...
    <div class="h-full px-2 py-4 pt-24 overflow-auto rounded-lg shadow-lg md:pt-6">
        ...
        {{-- subheaders --}}
            <div class="flex flex-col justify-between fill-mainwhitebg">
                <h1 class="w-1/2 py-4 text-lg font-bold md:text-xl" id="quiz_title" data-course-id="{{$learnerSyllabusProgressData->course_id}}" data-syllabus-id="{{$learnerSyllabusProgressData->syllabus_id}}"><span class="">{{ $learnerSyllabusProgressData->quiz_title }}</span></h1>
            </div>
        </div> 
        ...
        <div class="mx-2">
            ...
            <div class="flex mt-5 flex-col lg:flex-row">
                <div class="lg:w-2/6 border-r-2 border-green-200 px-auto" id="quiz_info_area">
            ...
            <div class="w-full text-right my-2" id="">
                <a href="{{ url("/learner/course/content/$learnerSyllabusProgressData->course_id/$learnerSyllabusProgressData->learner_course_id/quiz/$learnerSyllabusProgressData->syllabus_id")}}" class="btn btn-primary">Return</a>
            </div>
