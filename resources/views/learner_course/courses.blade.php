...
<section class="w-full h-screen md:w-3/4 lg:w-10/12">
    <div class="h-full px-2 py-4 pt-24 overflow-hidden overflow-y-scroll rounded-lg shadow-lg md:pt-0">
        ...
        <div class="py-4" id="welcome">
            <h1 class="text-xl font-semibold md:text-3xl">Learner <span
                    class="text-darthmouthgreen">{{$learner->learner_fname}} {{$learner->learner_lname}}</span></h1>
        </div>
        {{-- MAIN HEADER --}}
        <div class="flex flex-row items-center justify-between px-4">
            ...
            <form class="relative flex flex-row items-center" action="">
                ...
                <input class="w-32 h-10 pl-6 rounded-lg md:w-64 md:h-12" type="search" name="search" id="searchVal"
                    placeholder="search">
            </form>
        </div>
