...
<section class="w-full h-screen md:w-3/4 lg:w-10/12">
    <div class="h-full px-2 py-4 pt-24 overflow-hidden overflow-y-scroll rounded-lg shadow-lg md:pt-6">
        ...
        <div class="px-2">
            ...
            <div class="flex flex-col text-mainwhitebg fill-mainwhitebg">
                ...
                <h1 href="" style="background-color:{{$mainBackgroundCol}}"
                    onmouseover="this.style.backgroundColor='{{$darkenedColor}}'"
                    onmouseout="this.style.backgroundColor='{{$mainBackgroundCol}}'"
                    class="flex items-center justify-between px-2 py-4 my-2 text-white rounded-lg shadow-lg bg-seagreen">
                    <div class="flex items-center">
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_75_1498)">
                                <path
                ...
                @if($topic->status == "LOCKED")
                <h1 style="background-color:{{$mainBackgroundCol}}"
                    onmouseover="this.style.backgroundColor='{{$darkenedColor}}'"
                    onmouseout="this.style.backgroundColor='{{$mainBackgroundCol}}'"
                    class="flex items-center justify-between px-2 py-4 my-2 rounded-lg shadow-lg bg-seagreen">
                    <div class="flex items-center">
    ...
    <div id="syllabusModal"
        ...
        <div
            class="modal-content bg-white p-4 rounded-lg shadow-lg w-full lg:w-2/5 lg:h-3/4 min-h-[500px] overflow-y-auto">
            ...
            {{-- <span
                class="absolute top-0 right-0 mt-2 mr-4 text-2xl text-gray-600 cursor-pointer close">&times;</span> --}}
