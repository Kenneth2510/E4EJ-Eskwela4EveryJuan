    ...
    <div class="h-full px-2 py-4 pt-24 overflow-hidden overflow-y-scroll rounded-lg shadow-lg md:pt-6">
            ...
            @foreach ($activityOutput as $output)
                <div class="px-10 mt-8" id="score_area">
                    ...
                    <div class="p-6 bg-gray-100 shadow-md rounded-xl">
                        ...
                        <div class="my-3">
                            @if($output)
                            <a href="{{ url("/learner/course/content/$syllabus->course_id/$syllabus->learner_course_id/activity/$syllabus->syllabus_id/answer/$output->attempt") }}" class="">
        ...
        <div class="flex mt-5 space-x-2">
            ...
            @if ($activityOutput->isNotEmpty())
                    ...
                    @foreach($activityOutput as $output)
                        @if ($output->mark !== null || $output->mark !== '') {{-- if the mark is still null or no value --}}
                            ...
                            @if ($output->mark == 'PASS') {{-- if mark is PASS --}}
                                ...
                                <a class="w-1/2 cursor-not-allowed" >
                                    <button class="btn btn-disabled w-full ">Answer Now</button>    
                                </a>   
                            @else {{-- if mark is FAIL --}}
                                ...
                                <a disabled href="" class=" w-1/2 cursor-not-allowed">
                                    <button class="btn btn-disabled w-full ">Reattempt Now</button>
                                </a>   
                            @endif
                        ...
                        @else {{-- if mark is null and not yet started --}}
                            ...
                            <a href="{{ url("/learner/course/content/$syllabus->course_id/$syllabus->learner_course_id/activity/$syllabus->syllabus_id/answer/$output->attempt") }}" class="w-1/2">
                        ...
                        @if ($lastRowActivityData !== null)
                            @if ($lastRowActivityData->answer !== null) {{-- if not null--}}
                                ...
                                @if ($lastRowActivityData->mark == 'PASS') {{-- if mmark is PASS --}}
                                    ...
                                    <a disabled href="" class="w-1/2 cursor-not-allowed">
                                        <button class="btn btn-disabled w-full">Already Submitted</button>
                                    </a>    
                                @else {{-- if mark is FAIL --}}
            ...
            @else
                    ...
                    <a href="{{ url("/learner/course/content/$syllabus->course_id/$syllabus->learner_course_id/activity/$syllabus->syllabus_id/answer/1") }}" class="w-1/2">
                        <button class="btn btn-primary w-full">Answer Now</button>
                    </a>   
