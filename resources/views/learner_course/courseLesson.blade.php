...
<section class="w-full h-screen md:w-3/4 lg:w-10/12">
    <div class="h-full px-2 py-4 pt-24 overflow-auto rounded-lg shadow-lg md:pt-6">
        <div style="background-color:{{$mainBackgroundCol}};" class="z-50 p-2 text-white rounded-xl">
            ...
            <h1 class="w-1/2 py-4 text-2xl font-bold md:text-4xl"><span class="">{{ $syllabus->course_name }}</span>
            </h1>
            {{-- subheaders --}}
        ...
        <div class="px-2">
            ...
            <div class="mb-4">
                <div class="flex items-center justify-between pb-3 my-4 mt-5 border-b-2 border-seagreen">
                    <div class="relative flex items-center">
                        ...
                        {{-- <input class="ml-[50px] w-[750px] text-3xl font-bold border-none" disabled type="text"
                            name="lesson_title" id="lesson_title" value="{{ $syllabus->lesson_title }}"> --}}
                        <div id="lesson_title" data-course-id="{{$syllabus->course_id}}"
                            data-syllabus-id="{{$syllabus->syllabus_id}}"
                            class="pl-[50px] text-3xl font-bold border-none" contenteditable="false">{{
                            $syllabus->lesson_title }}</div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-5">
                ...
                <div id="lesson_img" class="flex justify-center w-full h-[400px] my-4 rounded-lg shadow">
                    <div class="w-full h-[400px] overflow-hidden rounded-lg">
                        <img src="{{ asset(" storage/$syllabus->picture") }}" class="object-contain w-full h-full"
                        alt="">
                    </div>
                </div>
            ...
            <div id="main_content_area" class="">
                ...
                <div data-content-order="{{$lesson->lesson_content_order}}"
                    class="w-full my-2 mb-8 lesson_content_area">
                    ...
                    @else
                    @endif
                    <div class="mt-5 text-xl font-normal contentArea lesson_content_input_disp"
                        style="white-space: pre-wrap">{!! $lesson->lesson_content !!}</div>

                    {{-- <p class="w-[80%] max-w-full min-w-full text-xl lesson_content_input_disp"
                        style="white-space: pre-wrap">{{$lesson->lesson_content}}</p>
                    <textarea name="lesson_content_input" id=""
