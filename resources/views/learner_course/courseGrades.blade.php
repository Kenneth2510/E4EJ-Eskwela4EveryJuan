...
<section class="w-full h-screen md:w-3/4 lg:w-10/12">
    <div class="h-full px-2 py-4 pt-24 overflow-hidden overflow-y-scroll rounded-lg shadow-lg md:pt-6">
        ...
        <div class="mt-10">
            ...
            <h1 class="py-5 mx-16 text-4xl font-bold text-green-600">{{$preAssessmentData->score}} <span class="text-2xl font-bold text-black"> / {{$totalScoreCount_pre_assessment}}</span></h1>
            <h1 class="py-5 mx-16 text-2xl font-bold text-green-600">Date Taken: <span class="text-2xl font-bold text-black">  {{$preAssessmentData->finish_period}}</span></h1>
        </div>
        ...
        <div class="mt-10">
            ...
            <h1 class="py-5 mx-16 text-4xl font-bold text-green-600">{{$postAssessmentGrade->average_score}} <span class="text-2xl font-bold text-black"> / {{$totalScoreCount_post_assessment}}</span></h1>
            <h1 class="py-5 mx-16 text-2xl font-bold text-green-600">Date Taken: <span class="text-2xl font-bold text-black"> / {{$postAssessmentGrade->latest_finish_period}}</span></h1>
        </div>
