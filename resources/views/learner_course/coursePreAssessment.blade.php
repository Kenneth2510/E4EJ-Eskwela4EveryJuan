        ...
        <div class="mx-2">
            ...
            <div class="flex flex-col justify-between py-4 border-b-2 lg:flex-row">
                <div class="flex flex-row items-center">
                    ...
                    <h1 class="mx-2 text-2xl font-semibold" id="titleArea"
                        data-course-id="{{$learnerCourseData->course_id}}">Pre Assessment</h1>
                </div>
            ...
            <div class="px-10 mt-8" id="score_area">
                ...
                <div class="p-6 bg-gray-100 shadow-md rounded-xl">
                    ...
                    <h1 class="text-4xl font-bold text-green-600">{{$preAssessmentData->score}} <span
                    ...
                    <div class="my-5">
                        ...
                        <span
                            class="mx-2 text-2xl font-semibold {{ in_array($preAssessmentData->remarks, ['Excellent', 'Very Good', 'Good']) ? 'text-dartmouthgreen' : 'text-red-600' }}">
                    ...
                    <div class="my-3">
                        @if($preAssessmentData->remarks)
                        <a href="{{ url("/learner/course/content/$learnerCourseData->course_id/$learnerCourseData->learner_course_id/pre_assessment/view_output")
                            }}" method="GET" class="">
            ...
            <div class="mt-[50px] flex justify-center items-center space-x-2">
                ...
                <a href="{{ url("/learner/course/content/$learnerCourseData->course_id/$learnerCourseData->learner_course_id/pre_assessment/answer")
                    }}" class="w-1/2">
