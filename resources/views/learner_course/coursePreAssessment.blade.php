        ...
        <div class="mx-2">
            ...
            <div class="px-10 mt-8" id="score_area">
                ...
                <div class="p-6 bg-gray-100 shadow-md rounded-xl">
                    ...
                    <div class="my-3">
                        @if($preAssessmentData->remarks)
                        <a href="{{ url("/learner/course/content/$learnerCourseData->course_id/$learnerCourseData->learner_course_id/pre_assessment/view_output") }}" method="GET" class="">
        ...
        <div class="mt-[50px] flex justify-center items-center space-x-2">
            {{-- @if(count($learnerQuizProgressData) == 1) --}}
                    ...
                    @if ($preAssessmentData->status == 'COMPLETED')
                        ...
                        <a href="{{ url("/learner/course/content/$learnerCourseData->course_id/$learnerCourseData->learner_course_id/pre_assessment/view_output") }}" class="w-1/2">
                    ...
                    <a href="{{ url("/learner/course/content/$learnerCourseData->course_id/$learnerCourseData->learner_course_id/pre_assessment/answer") }}" class="w-1/2">
