...
<section class="w-full h-auto text-black md:w-3/4 md:h-screen lg:w-10/12">
    <div class="h-full px-2 py-4 pt-12 rounded-lg shadow-lg md:overflow-auto md:pt-6" id="view_learner_container">

        <div id="title" class="flex items-center justify-between p-3 border-b-2 border-gray-300 md:py-8">
                ...
                <div class="flex flex-col w-full text-black lg:flex-row lg:text-white">
                    <div id="courseSidebar" class="text-center lg:bg-seagreen lg:rounded-s-md">
                        <ul class="flex flex-row justify-around p-5 text-base font-medium lg:flex-col">
                            <a href="/admin/manage_course/course_overview/{{ $course->course_id }}">
                                <li id="courseOverviewBtn"
                                    class="w-full px-2 py-5 selected rounded-xl hover:bg-green-900 hover:text-white ">
                            ...
                            <a href="/admin/manage_course/enrollees/{{ $course->course_id }}">
                                <li id="enrolledLearnersBtn"
                                    class="w-full px-2 py-5 rounded-xl hover:bg-green-900 hover:text-white">
                                    <i class="text-3xl fa-solid fa-users"></i>
                                    <p>Enrolled Learners</p>
                                </li>
                            </a>
                            <a href="/admin/manage_course/content/{{ $course->course_id }}">
                                <li id="courseContentBtn"
                                    class="w-full px-2 py-5 rounded-xl hover:bg-green-900 hover:text-white">
                    ...
                    <div id="courseOverview" class="">
                        <div
                            class="relative z-0 pb-4 bg-black border border-gray-400 rounded-lg shadow-lg text-mainwhitebg">
                            ...
                            <div class="z-50 flex items-center justify-between p-2">
                                ...
                                {{-- subheaders --}}
                                <div class="">
                                    <h1 class="w-1/2 py-4 text-4xl font-semibold"><span class="">{{ $course->course_name
                                            }}</span></h1>
                                    <div class="flex flex-col fill-mainwhitebg">
                                        <div class="flex flex-row my-2">
                                            <svg class="mr-2 " xmlns="http://www.w3.org/2000/svg" height="24"
                                    ...
                                    <div id="icon" class="mx-5 my-3 rounded-full">
                                        <img class="w-32 h-32 mx-auto my-3 bg-gray-400 rounded-full"
                                            src="{{ asset('storage/'. $course->profile_picture)}}"
                                            alt="Profile Picture">
                                        <p>Instructor</p>
                                        <p class="font-medium text-white">{{$course->instructor_fname}}
                                            {{$course->instructor_lname}} </p>
                                    </div>
                                </div>
                                <div id="icon" class="mx-5 my-3 rounded-full">
                                    <img class="w-32 h-32 mx-auto my-3 bg-gray-400 rounded-full"
                            ...
                            <div class="flex flex-col pt-4 mx-2 lg:w-1/5">
                                <div
                                    class="flex flex-row items-center py-4 my-2 bg-teal-400 rounded-lg shadow-lg justify-evenly">
                                    <svg class="w-10 h-10 mr-2" xmlns="http://www.w3.org/2000/svg" height="24"
                                        viewBox="0 -960 960 960" width="24">
                                        <path
                                ...
                                <div
                                    class="flex flex-row items-center py-4 my-2 rounded-lg shadow-lg bg-sky-400 justify-evenly">
                                    <svg class="w-10 h-10 mr-2" xmlns="http://www.w3.org/2000/svg" height="24"
                                        viewBox="0 -960 960 960" width="24">
                                        <path
                                ...
                                <div
                                    class="flex flex-row items-center py-4 my-2 rounded-lg shadow-lg bg-fuchsia-400 justify-evenly">
                                    <svg class="w-10 h-10 mr-2" xmlns="http://www.w3.org/2000/svg" height="24"
                                        viewBox="0 -960 960 960" width="24">
                                        <path
