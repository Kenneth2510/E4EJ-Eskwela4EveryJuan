                    ...
                    <div class="flex flex-col items-center justify-start w-3/12 h-full py-10 mx-5 bg-white rounded-lg shadow-lg"
                        ...
                        <div class="flex justify-center w-full px-5 mt-5">
                            ...
                            <button type="button"
                                ...
                                id="submit_new_instructor">Save new instructor</button>
                            @endif
                        </div>
                    ...
                    <div class="w-9/12 h-full" id="upper_right_container">
                                ...
                                <div class="w-1/2 mx-2" id="userInfo_left">
                                    ...
                                    <div class="mt-3" id="contactArea">
                                        ...
                                        <input class="w-full h-12 px-5 py-1 border-2 rounded-lg border-darthmouthgreen"
                                            ...
                                            id="instructor_contactno" value="" placeholder="09">
                        ...
                        <div class="w-full px-5 py-10 mt-5 bg-white shadow-lg rounded-xl" id="courseProgress">
                            ...
                            <input class="w-full h-12 px-5 py-1 rounded-lg" type="file" name="instructor_credentials"
                                id="instructor_credentials" value="">
                        ...
                        <div class="w-full px-5 py-10 mt-5 bg-white shadow-lg rounded-xl" id="upper_right_3">
                            ...
                            <div class="mt-3" id="instructor_usernameArea">
                                ...
                                <input class="w-full h-12 px-5 py-1 border-2 rounded-lg border-darthmouthgreen"
                                    type="text" name="instructor_username" id="instructor_username" value="">
                            ...
                            <div class="mt-3" id="instructorPasswordConfirmArea">
                                ...
                                <input class="w-full h-12 px-5 py-1 border-2 rounded-lg border-darthmouthgreen"
                                    type="password" name="instructorNewPasswordConfirm"
                                    id="instructorNewPasswordConfirm">
