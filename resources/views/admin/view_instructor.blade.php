        ...
        <div class="flex justify-between px-10">
            ...
            <div class="w-full px-3 pb-4 mt-10 rounded-lg shadow-lg b">
                ...
                <div class="flex justify-between">
                    <div class="flex flex-col items-center justify-start w-3/12 h-full py-10 mx-5 bg-white rounded-lg shadow-lg"
                        id="upper_left_container">
                        <div class="relative flex flex-col items-center justify-start"
                            style="margin:0 auto; padding: auto;">
                            <img class="z-0 w-40 h-40 rounded-full"
                        ...
                        <div class="mt-5 text-center" id="account_status_area">
                            ...
                            <div id="button" class="flex flex-col hidden mx-4">
                                ...
                                <form action="/admin/block_instructor/{{$instructor->instructor_id}}" method="POST">
                                    ...
                                    @csrf
                                    <button
                                        class="px-5 py-3 mx-2 my-1 text-lg text-white bg-red-600 hover:border-2 hover:bg-white hover:border-red-600 hover:text-red-600 rounded-xl">block
                                        now</button>
                                </form>
                            </div>
                            @elseif ($instructor->status == 'Blocked')
                            <div id="status" class="px-5 py-3 my-1 text-lg text-white bg-red-500 rounded-xl">Blocked
                            </div>
                            <div id="button" class="flex flex-col hidden mx-4">
                                <form action="/admin/pending_instructor/{{$instructor->instructor_id}}" method="POST">
                                    @method('put')
                        ...
                        <div class="flex justify-center w-full px-5 mt-5">
                            ...
                            <div class="flex flex-col items-center justify-center w-full px-5 mt-5">
                                <button type="button"
                                    class="px-5 py-3 my-1 text-lg text-white bg-darthmouthgreen hover:border-2 hover:bg-white hover:border-darthmouthgreen hover:text-darthmouthgreen rounded-xl"
                                    id="edit_info_btn">Edit Info</button>

                                <button type="button"
                                    class="hidden px-5 py-3 mx-2 my-1 text-lg text-white bg-darthmouthgreen hover:border-2 hover:bg-white hover:border-darthmouthgreen hover:text-darthmouthgreen rounded-xl"
                                    id="apply_change_btn">Apply Changes</button>


                                {{-- <button type="button"
                                    class="hidden px-5 py-3 mx-2 my-1 text-lg text-white bg-red-600 hover:border-2 hover:bg-white hover:border-red-600 hover:text-red-600 rounded-xl"
                                    id="delete_btn">Delete</button> --}}

                                <button type="button"
                                    class="hidden px-5 py-3 my-1 text-lg text-white bg-gray-500 hover:border-2 hover:bg-white hover:border-gray-500 hover:text-gray-500 rounded-xl"
                    ...
                    <div class="w-9/12 h-full" id="upper_right_container">
                            ...
                            <div class="flex w-full mt-5" id="userInfo">
                                <div class="w-1/2 mx-2" id="userInfo_left">
                                    ...
                                    <div class="mt-3" id="contactArea">
                                        ...
                                        <input class="w-full h-12 px-5 py-1 border-2 rounded-lg border-darthmouthgreen"
                                            type="text" maxlength="11" name="instructor_contactno"
                                            id="instructor_contactno" value="{{$instructor->instructor_contactno}}"
                                            disabled placeholder="09">
                        ...
                        <div class="w-full px-5 py-10 mt-5 bg-white shadow-lg rounded-xl" id="upper_right_3">
                            ...
                            <div class="mt-3" id="instructor_usernameArea">
                                ...
                                <input class="w-full h-12 px-5 py-1 border-2 rounded-lg border-darthmouthgreen"
                                    type="text" name="instructor_username" id="instructor_username"
                            ...
                            <div class="mt-3" id="securityCodeArea">
                                ...
                                <input class="w-full h-12 px-5 py-1 border-2 rounded-lg border-darthmouthgreen"
                                    type="password" maxlength="6" name="instructor_security_code"
                                    id="instructor_security_code" value="{{$instructor->instructor_security_code}}"
                                    disabled>
