                        ...
                        <div class="w-full mt-5" id="userInfo">
                            ...
                            <div class="w-full mt-3" id="codenameArea">
                                ...
                                <input class="w-full h-12 px-5 py-1 border-2 rounded-lg border-darthmouthgreen"
                                    type="text" name="admin_codename" id="admin_codename"
                                    value="{{$adminData->admin_codename}}" disabled>
                    ...
                    <div class="w-full px-5 py-10 mt-5 bg-white shadow-lg rounded-xl" id="upper_right_3">
                        ...
                        <div class="mt-3" id="usernameArea">
                            ...
                            <input class="w-full h-12 px-5 py-1 border-2 rounded-lg border-darthmouthgreen" type="text"
                                name="admin_username" id="admin_username" value="{{$adminData->admin_username}}">
