    ...
    <section class="w-screen px-2 pt-[40px] mx-2 mt-2  overscroll-auto md:overflow-auto">
        ...
        <div class="w-full px-3 pb-4 mt-10 rounded-lg shadow-lg b">
            ...
            <div class="flex justify-between">
                <div class="flex flex-col items-center justify-start w-5/12 h-full py-10 mx-5 bg-white rounded-lg shadow-lg"
                    id="upper_left_container">
                    <div class="relative flex flex-col items-center justify-start" id="learner_profile_photo"
                        style="margin:0 auto; padding: auto;">
                        <img class="z-0 w-40 h-40 rounded-full" src="{{ asset('storage/images/default_profile.png')}}"
                            alt="Profile Picture">
                    </div>

                    <div class="mt-10" id="name_area">
                        <h1 class="text-2xl font-semibold text-center" id="nameDisp">{{$learnerCourse->learner_fname}}
                            {{$learnerCourse->learner_lname}}</h1>
                    ...
                    <div class="flex justify-center my-2" id="learnerAreaID">
                        <select class="w-full px-5 py-3 mx-2 text-sm border border-darthmouthgreen rounded-xl"
                            name="learnerID" id="learnerID" disabled>
                            <option value="" selected disabled>choose a learner</option>
                            @foreach ($learners as $learner)
                            <option value="{{$learner->learner_id}}" {{$learnerCourse->learner_id ==
                                $learner->learner_id ? 'selected' : ''}}>{{$learner->name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="flex justify-center my-2" id="courseAreaID">
                        <select class="w-full px-5 py-3 mx-2 text-sm border border-darthmouthgreen rounded-xl"
                            name="courseID" id="courseID" disabled>
                    ...
                    <div class="mt-5 text-center" id="account_status_area">
                        ...
                        <div id="status" class="px-5 py-3 my-1 text-lg text-white bg-darthmouthgreen rounded-xl">
                            Approved</div>
                        <div id="button" class="flex flex-col hidden mx-4">
                            <form action="/admin/manage_course/enrollee/pending/{{$learnerCourse->learner_course_id}}"
                                method="POST">
                                @method('put')
                                @csrf
                                <button
                                    class="px-5 py-3 mx-2 my-1 text-lg text-white bg-yellow-500 hover:border-2 hover:bg-white hover:border-yellow-500 hover:text-yellow-500 rounded-xl">change
                                    to pending</button>
                            </form>
                            <form action="/admin/manage_course/enrollee/reject/{{$learnerCourse->learner_course_id}}"
                                method="POST">
                                @method('PUT')
                                @csrf
                                <button
                                    class="px-5 py-3 mx-2 my-1 text-lg text-white bg-red-600 hover:border-2 hover:bg-white hover:border-red-600 hover:text-red-600 rounded-xl">reject
                                    now</button>
                            </form>
                        </div>
                        ...
                        <div id="button" class="flex flex-col hidden mx-4">
                            ...
                            <form action="/admin/manage_course/enrollee/approve/{{$learnerCourse->learner_course_id}}"
                                method="POST">
                                @method('put')
                                @csrf
                                <button type="submit"
                                    class="px-5 py-3 my-1 text-lg text-white bg-darthmouthgreen hover:border-2 hover:bg-white hover:border-darthmouthgreen hover:text-darthmouthgreen rounded-xl">approve
                                    now</button>
                            </form>
                        </div>
                        @else
                        <div id="status" class="px-5 py-3 my-1 text-lg text-white bg-yellow-500 rounded-xl">pending
                        </div>
                        <div id="button" class="flex flex-col hidden mx-4">
                            <form action="/admin/manage_course/enrollee/approve/{{$learnerCourse->learner_course_id}}"
                                method="POST">
                            ...
                            <form action="/admin/manage_course/enrollee/reject/{{$learnerCourse->learner_course_id}}"
                                ...
                                @csrf
                                <button
                                    class="px-5 py-3 mx-2 my-1 text-lg text-white bg-red-600 hover:border-2 hover:bg-white hover:border-red-600 hover:text-red-600 rounded-xl">reject</button>
                            </form>
                    ...
                    <div class="flex justify-center w-full px-5 mt-5">
                        ...
                        'COURSE_ASST_SUPERVISOR']))
                        <button type="button"
                            class="px-5 py-3 mx-2 text-lg text-white bg-darthmouthgreen hover:border-2 hover:bg-white hover:border-darthmouthgreen hover:text-darthmouthgreen rounded-xl"
                            id="changeStatusBtn">Update Enrollment Status</button>
                        <button type="button"
                            class="hidden px-5 py-3 mx-2 text-lg text-white bg-darthmouthgreen hover:border-2 hover:bg-white hover:border-darthmouthgreen hover:text-darthmouthgreen rounded-xl"
                            id="cancelChangeStatusBtn">Cancel</button>
                        @endif
                    </div>
                </div>
                ...
                <div class="w-9/12 h-full mx-2" id="upper_right_container">
                            ...
                            <div class="w-1/2 mx-2" id="userInfo_right">
                                ...
                                <div class="mt-3" id="genderArea">
                                    ...
                                    <select disabled
                                        ...
                                        <option value="Male" {{$learnerCourse->learner_gender = "Male" ? 'selected' :
                                            ''}}>Male</option>
                                        <option value="Female" {{$learnerCourse->learner_gender = "Female" ? 'selected'
                                            : ''}}>Female</option>
                                        <option value="Others" {{$learnerCourse->learner_gender = "Others" ? 'selected'
                    ...
                    <div class="w-full px-5 py-10 mt-5 bg-white shadow-lg rounded-xl" id="upper_right_2">
                        ...
                        <div class="flex justify-between w-full">
                            ...
                            <div class="w-full mt-3 mr-2" id="business_categoryArea">
                                ...
                                <select disabled
                                    ...
                                    <option value="Micro" {{$learnerCourse->business_category == 'Micro' ? 'selected' :
                                        ''}}>Micro</option>
                                    <option value="Small" {{$learnerCourse->business_category == 'Small' ? 'selected' :
                                        ''}}>Small</option>
                                    <option value="Medium" {{$learnerCourse->business_category == 'Medium' ? 'selected'
                                        : ''}}>Medium</option>
                                </select>
                            ...
                            <div class="w-full mt-3 ml-2" id="business_classificationArea">
                                ...
                                <select disabled
                                    ...
                                    <option value="" {{$learnerCourse->business_classification == '' ? 'selected' : ''}}
                                        disabled>-- select an option --</option>
                                    <option value="Retail" {{$learnerCourse->business_classification == 'Retail' ?
                                        'selected' : ''}}>Retail</option>
                                    <option value="Wholesale" {{$learnerCourse->business_classification == 'Wholesale' ?
                                        'selected' : ''}}>Wholesale</option>
                                    <option value="Financial Services" {{$learnerCourse->business_classification ==
                                        'Financial Services' ? 'selected' : ''}}>Financial Services</option>
                                    <option value="Real Estate" {{$learnerCourse->business_classification == 'Real
                                        Estate' ? 'selected' : ''}}>Real Estate</option>
                                    <option value="Transportation and Logistics" {{$learnerCourse->
                                        business_classification == 'Transportation and Logistics' ? 'selected' :
                                        ''}}>Transportation and Logistics</option>
                                    <option value="Technology" {{$learnerCourse->business_classification == 'Technology'
                                        ? 'selected' : ''}}>Technology</option>
                                    <option value="Healthcare" {{$learnerCourse->business_classification == 'Healthcare'
                                        ? 'selected' : ''}}>Healthcare</option>
                                    <option value="Education and Training" {{$learnerCourse->business_classification ==
                                        'Education and Training' ? 'selected' : ''}}>Education and Training</option>
                                    <option value="Entertainment and Media" {{$learnerCourse->business_classification ==
                                        'Entertainment and Media' ? 'selected' : ''}}>Entertainment and Media</option>
                                    <option value="Hospitality and Tourism" {{$learnerCourse->business_classification ==
                        ...
                        <div class="mt-3" id="business_descriptionArea">
                            ...
                            <textarea name="business_description" disabled
                                class="w-full px-5 py-1 border-2 rounded-lg h-36 border-darthmouthgreen"
                                id="business_description" disabled>{{$learnerCourse->business_description}}</textarea>
                    ...
                    <div class="w-full px-5 py-10 bg-white shadow-lg rounded-xl" id="upper_right_1">
                        ...
                        <div class="w-full mt-5" id="userInfo">
                            ...
                            <div class="w-full mt-3" id="courseNameArea">
                                ...
                                <input disabled class="w-full h-12 px-5 py-1 border-2 rounded-lg border-darthmouthgreen"
                                    type="text" name="course_name" id="course_name"
                                    value="{{$learnerCourse->course_name}}">
                            ...
                            <div class="w-full mt-3" id="courseDifficultyArea">
                                ...
                                <select disabled
                                    class="w-full h-12 px-10 py-1 border-2 rounded-lg border-darthmouthgreen"
                                    ...
                                    <option value="Beginner" {{$learnerCourse->course_difficulty == 'Beginner' ?
                                        'selected' : ''}}>Beginner</option>
                                    <option value="Intermmediate" {{$learnerCourse->course_difficulty == 'Intermmediate'
                                        ? 'selected' : ''}}>Intermmediate</option>
                                    <option value="Advanced" {{$learnerCourse->course_difficulty == 'Advanced' ?
                            ...
                            <div class="mt-3" id="course_descriptionArea">
                                ...
                                <textarea disabled name="course_description"
                                    class="w-full px-5 py-1 border-2 rounded-lg h-36 border-darthmouthgreen"
                                    id="course_description">{{$learnerCourse->course_description}}</textarea>
                    ...
                    <div class="w-full px-5 py-10 mt-5 bg-white shadow-lg rounded-xl" id="upper_right_3">
                        ...
                        <div class="w-full mt-3" id="courseInstructorArea">
                            ...
                            <select disabled class="w-full h-12 px-10 py-1 border-2 rounded-lg border-darthmouthgreen"
                                ...
                                <option value="{{$instructor->id}}" {{$learnerCourse->instructor_id == $instructor->id ?
