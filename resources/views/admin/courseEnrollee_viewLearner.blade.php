...
<section class="w-full h-auto text-black md:w-3/4 md:h-screen lg:w-10/12">
    <div class="h-full px-2 py-4 pt-24 rounded-lg shadow-lg md:overflow-hidden md:overflow-y-scroll md:pt-6">
        ...
        <div class="py-4 space-y-2 lg:flex lg:space-y-0 lg:space-x-2">
            <div class="flex flex-col items-center justify-start h-full p-3 bg-white rounded-lg shadow-lg lg:w-5/12"
                ...
                <div class="mt-5 space-y-3 text-center" id="account_status_area">
                    ...
                    <div id="status" class="btn btn-error">Rejected</div>
                    <div id="button" class="flex flex-col hidden space-y-2">
                        <form action="/admin/manage_course/enrollee/pending/{{$learnerCourse->learner_course_id}}"
                            method="POST">
                            @method('put')
                ...
                <div class="flex justify-center w-full px-5 mt-5">
                    @if(in_array($admin->role, ['IT_DEPT', 'SUPER_ADMIN', 'COURSE_SUPERVISOR',
                    'COURSE_ASST_SUPERVISOR']))
                    <button type="button" class="btn btn-primary" id="changeStatusBtn">Update Enrollment Status</button>
                    <button type="button" class="hidden btn" id="cancelChangeStatusBtn">Cancel</button>
                    @endif
                </div>
            </div>
            ...
            <div class="h-full mx-2 lg:w-9/12" id="upper_right_container">
