...
<div id="createNewMessage" class="fixed top-0 left-0 z-[97] flex items-center justify-center hidden w-full h-full bg-gray-200 bg-opacity-75">
...
<div id="selectRecipientsModal" class="fixed z-[98] top-0 left-0 flex items-center justify-center hidden w-full h-full bg-gray-200 bg-opacity-75">
