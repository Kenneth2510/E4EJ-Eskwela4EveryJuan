                ...
                <form class="flex flex-col justify-center rounded-lg md:mt-4 h-96 md:w-3/4 md:mx-auto lg:w-full lg:text-mainwhitebg" action="{{ url('/learner/login') }}" method="POST">
                    ...
                    <div class="pb-4 mx-4 text-sm border-b-4 md:text-base">
                        <div class="flex flex-col my-4 lg:flex-row lg:justify-between lg:items-center">
                            <label class="text-xl font-medium text-darthmouthgreen lg:w-1/2" for="learner_username">Username:</label>
                            {{-- <div class="relative lg:w-1/2">
                                <i class="fa-solid fa-user" style="color: #00693e"></i>
                        ...
                        <div class="flex flex-col my-4 lg:flex-row lg:justify-between lg:items-center">
                            <label class="text-xl font-medium text-darthmouthgreen lg:w-1/2" for="learner_password">Password:</label>
                            {{-- <div class="relative lg:w-1/2">
                                ...
                                <input required class="w-full h-8 pl-10 rounded text-darthmouthgreen md:h-10 lg:h-12 md:pl-12"
                                type="password"
                                name="password"
                                id="password">
                        ...
                        <div class="flex justify-end w-full">
                            <span class="font-bold text-right text-darthmouthgreen md:text-darthmouthgreen">
                                <a href="{{url('/learner/forgot')}}">
                                    Forgot Password?
                                </a>
                            </span>
                        </div>

                        @if ($errors->has('learner_username') && $errors->has('password'))
                        <p class="p-1 mt-2 text-lg font-semibold text-red-500">
                            Both username and password are required.
                        </p>
                        @else
                            @error('learner_username_login')
                            <p class="p-1 mt-2 text-lg font-semibold text-red-500">
                                {{$message}}
                            </p>
                            @enderror
                        ...
                        <div class="flex items-center justify-end px-4 my-4 md:text-base">
