...
<section class="w-full h-auto md:h-screen md:w-3/4 lg:w-10/12">
    <div class="h-full px-2 py-4 pt-24 rounded-lg shadow-lg md:overflow-hidden md:overflow-y-scroll md:pt-6">
        ...
        <div class="" id="learnerQuizProgressChartContainer">
            ...
            <div class="flex flex-col justify-between space-y-2 lg:flex-row lg:space-x-2 lg:space-y-0">
                <div class="lg:w-2/3 h-full border-2 border-darthmouthgreen" id="learnerQuizProgressLineChartArea">
                    <canvas id="learnerQuizProgressLineChart"></canvas>
                </div>
                <div class="lg:w-1/3 h-full border-2 border-darthmouthgreen"  id="learnerQuizProgressRemarksChartArea">
