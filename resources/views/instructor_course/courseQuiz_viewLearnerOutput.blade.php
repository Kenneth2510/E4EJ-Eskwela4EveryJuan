    ...
    <section class="w-full h-screen md:w-3/4 lg:w-10/12">
        <div class="h-full px-2 py-4 pt-24 overflow-hidden overflow-y-scroll rounded-lg shadow-lg md:pt-6">
            <div style="background-color:{{$mainBackgroundCol}}" class="z-50 p-2 text-white fill-white rounded-xl">
                ...
                <h1 class="w-1/2 py-4 text-2xl font-bold md:text-3xl lg:text-4xl"><span class="">{{ $course->course_name }}</span></h1>
            {{-- subheaders --}}
                <div class="flex flex-col justify-between fill-mainwhitebg">
                    <h1 class="w-1/2 py-4 text-lg font-bold md:text-xl"><span class="">{{ $quizData->quiz_title }}</span></h1>
                </div>
            </div>
            ...
            <div class="mx-2">
                ...
                {{-- head --}}
                <div class="flex flex-col justify-between py-4 border-b-2 lg:flex-row2">
            ...
            <div class="w-full text-right" id="">
                <a href="{{ url("/instructor/course/content/$quizData->course_id/$quizData->syllabus_id/quiz")}}" class="btn my-2">Return</a>
            </div>
                </div>
            </div>
        </div>
