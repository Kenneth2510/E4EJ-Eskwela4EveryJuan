        ...
        <div class="mx-2">
            ...
            <div class="py-4 " id="defaultView">
                ...
                <div id="coverageArea" class="mt-5">
                    <table class="w-full">
                        ...
                        <tbody class="referenceTable">
                            ...
                            <tr>
                                ...
                                <td class="w-1/5">
                                    <button class="hidden btn btn-primary">Edit</button>
                    ...
                    <button id="addNewReference" class="hidden btn btn-accent">Add Reference</button>
                ...
                {{-- <div class="mt-16" id="durationArea">
                    ...
                    <div class="flex flex-col space-y-2 lg:flex-row lg:space-y-0 lg:space-x-2">
                        ...
                        <input disabled
                            class="w-2/12 px-1 mx-3 text-lg border-2 border-gray-400 rounded-lg duration_input"
                            type="number" id="hours" name="hours" min="0" placeholder="0" value="0" required>

                        <label class="text-lg" for="minutes">Minutes:</label>
                        <input disabled
                            class="w-2/12 px-1 mx-3 text-lg border-2 border-gray-400 rounded-lg duration_input"
                            type="number" id="minutes" name="minutes" min="0" max="59" placeholder="0" value="0"
                            required>

                        <label class="text-lg" for="seconds">Seconds:</label>
                        <input disabled
                            class="w-2/12 px-1 mx-3 text-lg border-2 border-gray-400 rounded-lg duration_input"
                            type="number" id="seconds" name="seconds" min="0" max="59" placeholder="0" value="0"
                            required>

                        <button id="saveDurationBtn" class="hidden btn btn-primary">Set Duration</button>
                    </div>
                </div> --}}

                <div class="my-8 space-x-2">
                    {{-- <span id="" class="text-red-600">Make sure to set the duration time before going to the
                        editor</span> --}}
                    <button id="editQuizInfoBtn" class="btn btn-primary">Edit</button>
                </div>

                <div class="hidden mt-5" id="editQuizInfo_clickedBtns">
                    <button id="saveQuizInfoBtn" class="btn btn-primary">Finish Editing</button>
                </div>
                <div class="flex w-full mt-5 space-x-2">
                    <button id="viewResponsesBtn" class="w-1/2 btn btn-accent">
                        View Responses
                    </button>
                    <a href="{{ url("/instructor/course/content/$quizInfo->course_id/$quizInfo->syllabus_id/quiz/$quizInfo->quiz_id/content")
