        ...
        <div class="relative w-full h-full px-2 py-4 pt-24 overflow-hidden overflow-y-scroll rounded-lg shadow-lg md:pt-4">
            ...
            {{-- subheaders --}}
                <div class="flex flex-col fill-mainwhitebg">
                    <h1 class="w-1/2 py-4 text-lg"><span class="">{{ $activity->activity_title }}</span></h1>
                </div>
            </div>
            ...
            <div class="mx-2">
                ...
                <div class="py-4 " id="defaultView">
                    ...
                    <div class="overflow-auto">
                        <table class="table w-full table-auto">
                            <thead class="text-xl text-white bg-green-700 rounded-xl">
                                ...
                                <th class="w-[150px]">Max Score</th>
                                <th class="w-[150px]"><span id="given_score" class="">Given Score</span></th>
                            </thead>
                            <tbody>
                    ...
                    <div class="p-6 bg-gray-100 shadow-md rounded-xl">
                        ...
                        @else
                            <div class="my-5">
                                <a href="{{ url("/instructor/course/content/$activity->course_id/$activity->syllabus_id/activity/$learnerActivityOutput_2nd->learner_course_id/$learnerActivityOutput_2nd->attempt") }}"  class="px-5 py-3 text-lg font-semibold text-white bg-darthmouthgreen hover:bg-green-950 rounded-xl">View Second Attempt</a>
                            </div>
                        @endif
                ...
                <div class="flex justify-center w-full space-x-2">
                    <a id="returnBtn" href="/instructor/course/content/{{$activity->course_id}}/{{$activity->syllabus_id}}}/activity" class="w-1/2 btn">Return</a>
                    <button id="cancelScoreBtn" class="hidden w-1/2 btn btn-danger">Cancel</button>
                    <button id="addScoreBtn" class="w-1/2 btn btn-primary">Add Score</button>
                    <button id="submitScoreBtn" class="hidden w-1/2 btn btn-primary">Submit Score</button>
                </div>
            </div>
