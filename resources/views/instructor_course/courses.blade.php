...
<section class="w-full h-screen md:w-3/4 lg:w-10/12">
    <div class="h-full px-2 py-4 pt-24 overflow-hidden overflow-y-scroll rounded-lg shadow-lg md:pt-0">
        <div class="py-4" id="welcome">
            <h1 class="text-2xl font-semibold md:text-3xl">Instructor <span
                    class="text-darthmouthgreen">{{$instructor->instructor_fname}}
                    {{$instructor->instructor_lname}}</span></h1>
        </div>
        {{-- MAIN HEADER --}}
        <div class="flex flex-row items-center justify-between px-4">
            ...
            <form class="relative flex flex-row items-center" action="">
                ...
                <input class="w-32 h-10 pl-6 rounded-lg md:w-64 md:h-12" type="search" name="search" id="searchCourse"
                    placeholder="search">
            </form>
        </div>
                    ...
                    <div class="relative px-3 py-2 m-4 rounded-lg shadow-lg w-52 bg-primary">
                        <div style="background-color: #9DB0A3" class="relative h-32 mx-auto my-3 rounded w-44">
                            <img class="absolute w-16 h-16 bg-yellow-500 rounded-full right-3 -bottom-4"
                                src="{{ asset('storage/' . $instructor->profile_picture) }}" alt="">
                        </div>
                        ...
                        <a href="{{ url("/instructor/course/$course->course_id") }}" style="background-color: #00693e;
        ...
        <div
            class="flex flex-row flex-wrap items-center justify-center mx-auto mt-5 border-2 rounded-lg shadow grow lg:justify-start">
            ...
            <div class="flex flex-row flex-wrap items-center justify-center" id="coursesArea">
                ...
                <a href="{{ url('/instructor/courses/create') }}"
                    class="flex flex-col items-center justify-center m-4 bg-white rounded-lg shadow-lg w-52 h-72"
                    id="addNewCourse">
                    <svg class="w-24 h-24" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960"
                        width="24">
