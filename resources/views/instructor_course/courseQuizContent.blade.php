        ...
        <div class="relative w-full h-full px-2 py-4 pt-24 overflow-hidden overflow-y-scroll rounded-lg shadow-lg md:pt-4">
            ...
            <div class="mx-2">
                ...
                <div class="w-full mt-10 quizContentArea">
                    ...
                    <div class="flex justify-center w-full py-5 space-x-2 quizOptions">
                        <button class="w-1/2 btn btn-accent lg:w-auto" id="addExistingQuestionBtn">
                            Add Existing Question
                        </button>
                        <button class="w-1/2 btn btn-primary lg:w-auto" id="addNewQuestionBtn">
                            Add New Question
                        </button>
                    </div>
                    <div class="flex justify-center w-full py-5 mt-5 space-x-2 border-t-2 border-gray-400">
                        <button class="w-1/2 btn btn-danger">
                            <a id="cancelQuizBuild" href="{{ url("/instructor/course/content/$course->course_id/$quizInfo->syllabus_id/quiz") }}" class="">
                        Cancel
                            </a>
                        </button>
                        <button class="w-1/2 saveQuizContent btn btn-primary">
                            Save Changes
                        </button>
                    </div>
                </div>
