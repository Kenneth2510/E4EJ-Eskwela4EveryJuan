        ...
        <div class="relative w-full h-full px-2 py-4 pt-24 overflow-hidden overflow-y-scroll rounded-lg shadow-lg md:pt-4">
            ...
            <div class="mx-2">
                ...
                <div class="py-4 " id="defaultView">
                    ...
                    <textarea name="activity_instructions" class="w-full max-w-full min-w-full activity_instructions max-h-[200px]" disabled>{{$activityContent->activity_instructions}}</textarea>
                    ...
                    <div class="hidden mt-3" id="editCriteria_clickedBtn"> 
                        <button id="saveCriteriaBtn" data-activity-content-id="{{$activityContent->activity_content_id}}" class="p-3 text-white rounded-xl bg-darthmouthgreen hover:bg-green-900">Save Criteria</button>
                    ...
                    <div class="">
                        ...
                        <input type="number" id="overallScore_input py-5 px-5 border-2 border-green-400" class="w-full text-4xl" value="{{$activityContent->total_score}}" disabled> 
                ...
                <div class="my-2" id="studentsList" data-course-id="{{$activityInfo->course_id}}" data-syllabus-id="{{$activityInfo->syllabus_id}}">
                </div>
            ...
            <div class="flex justify-between">
                <button id="editActivityBtn" class="w-1/2 h-16 px-5 py-3 mx-3 text-white bg-darthmouthgreen hover:bg-green-900 rounded-xl" data-course-id="{{$course->course_id}}" data-syllabus-id="{{$activityInfo->syllabus_id}}">Edit</button>
                ...
                <button id="viewResponseActivity" class="w-1/2 h-16 px-5 py-3 mx-3 text-white bg-darthmouthgreen hover:bg-green-900 rounded-xl" data-course-id="{{$course->course_id}}" data-syllabus-id="{{$activityInfo->syllabus_id}}">View Responses</button>
...
<div id="responsesModal" class="fixed top-0 left-0 z-50 flex items-center justify-center hidden w-full h-full bg-gray-200 bg-opacity-75">
    <div class="w-3/5 max-h-[600px] p-4 bg-white rounded-lg shadow-lg modal-content">
        ...
        <div id="responsesContent" class="mt-5 overflow-y-auto ">
            <table class="w-full overflow-y-auto h-11/12">
