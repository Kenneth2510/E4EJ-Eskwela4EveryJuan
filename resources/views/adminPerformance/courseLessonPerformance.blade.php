...
<section class="flex flex-row w-screen text-sm main-container bg-mainwhitebg md:text-base">
    ...
    <section class="w-screen px-2 pt-[40px] mx-2 mt-2  overscroll-auto md:overflow-auto">
        ...
        <div class="mt-10">
            ...
            <h1 class="mx-5 text-2xl font-semibold">{{$courseData->course_name}} Lessons Overview</h1>
        ...
        <div class="flex justify-between px-7" id="learnerSyllabusChartsArea">
            ...
            <div class="w-1/2 h-[350px] ml-5 border-2 border-darthmouthgreen" id="learnerSyllabusStatusChartArea">
                <canvas id="learnerSyllabusStatusChart"></canvas>
            </div>

            <div class="w-1/2 h-[350px] ml-5 border-2 border-darthmouthgreen" id="learnerSyllabusStatusTimeChartArea">
