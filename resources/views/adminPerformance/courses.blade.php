            ...
            <tbody class="">
                ...
                <tr class="">
                    ...
                    <td class="w-1/12">
                        ...
                        <a href="/admin/performance/courses/view/{{$course->course_id}}" class="px-3 py-2 mx-3 text-lg font-medium bg-green-600 rounded-xl hover:bg-green-900 hover:text-white">view</a>
                        @endif
                    </td>
                </tr>
                @empty
