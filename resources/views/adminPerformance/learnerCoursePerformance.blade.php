...
<section class="flex flex-row w-screen text-sm main-container bg-mainwhitebg md:text-base">
    ...
    <section class="w-screen px-2 pt-[40px] mx-2 mt-2  overscroll-auto md:overflow-auto">
        ...
        <div class="mt-10">
            ...
            <h1 class="mx-5 text-2xl font-semibold">Learner {{$learner->learner_fname}} {{$learner->learner_lname}}'s
                Overview</h1>
        ...
        <div class="flex p-10 mt-5" id="genInfo">
            <div class="w-1/2 mx-3 h-[300px] border-2 border-darthmouthgreen" id="totalLearnerPerformancePercent">
                <div class="flex justify-center mx-10 mt-10 text-center h-2/3 item-center">
                    ...
                    <p class="mx-5 mt-3 text-2xl font-bold py-14"><span class="text-darthmouthgreen text-[125px]"
                            id="learnerPerformancePercent">0</span><span
                            class="text-darthmouthgreen text-[125px]">%</span><br>Syllabus Topics Completed</p>
                </div>
                <div class="flex justify-center mt-5">
                    ...
                    <div class="flex items-center mx-1">
                        ...
                        <p class="font-bold text-md">IN PROGRESS: <span id="totalInProgressSyllabus" class="">0</span>
                        </p>
                    </div>

                    <div class="flex items-center mx-1">
                        <div class="w-3 h-3 mx-2 bg-red-700 rounded-full"></div>
                        <p class="font-bold text-md">NOT YET STARTED: <span id="totalLockedSyllabus" class="">0</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="w-1/2 mx-3 h-[300px] border-2 border-darthmouthgreen" id="averageLearnerProgressTime">
                <div class="flex justify-center mx-10 mt-10 text-center h-2/3 item-center">
                    ...
                    <p class="mx-5 mt-3 text-2xl font-bold py-14"><span class="text-darthmouthgreen text-[50px]"
                            id="averageLearnerProgress">0</span><br>Average Time of Completion</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex p-10 mt-5" id="gradeSheetArea">
            <div class="overflow-y-auto w-2/5 mx-3 text-center h-[300px] border-2 border-darthmouthgreen"
                id="overallGrade">

                <h1 class="mx-5 mt-5 mb-5 text-4xl">Course Grade</h1>
                <p class="mx-5 mt-3 text-2xl font-bold py-14"><span class="text-darthmouthgreen text-[125px]"
                        id="learnerPerformancePercent">{{$learnerCourseData->grade}}</span><span
                        class="text-darthmouthgreen text-[125px]"></span><br>{{$learnerCourseData->remarks}}</p>
                <div class="">
                    <div class="mt-10">
                        <h1 class="mx-2 text-2xl font-semibold">Pre Assessment</h1>
                        <h1 class="py-5 mx-16 text-4xl font-bold text-green-600">
                            {{$gradeComputation['preAssessmentLearnerSumScore']}} <span
                                class="text-2xl font-bold text-black"> /
                                {{$gradeComputation['totalScoreCount_pre_assessment']}}</span></h1>
                    </div>
                    ...
                    <div class="mt-10">
                        ...
                        <h1 class="py-5 mx-16 text-4xl font-bold text-green-600">
                            {{$gradeComputation['postAssessmentLearnerSumScore']}} <span
                                class="text-2xl font-bold text-black"> /
                                {{$gradeComputation['totalScoreCount_post_assessment']}}</span></h1>
                    </div>
                    ...
                    <div class="px-10 mt-3">
                        ...
                        <p class="py-5 mx-16 text-xl font-bold">[[ {{ $gradeComputation['activityLearnerSumScore'] }} /
                            {{ $gradeComputation['activityTotalSum'] }} ] x 100 ] x 35% = {{
                            $gradeComputation['activityGrade'] }}%</p>


                        <h1 class="text-xl font-bold">Quizzes</h1>
                        <p class="py-5 mx-16 text-xl font-bold">[[ {{ $gradeComputation['quizLearnerSumScore'] }} / {{
                            $gradeComputation['quizTotalSum'] }} ] x 100 ] x 35% = {{ $gradeComputation['quizGrade'] }}%
                        </p>


                        <h1 class="text-xl font-bold">Post Assessment</h1>
                        <p class="py-5 mx-16 text-xl font-bold">[[ {{ $gradeComputation['postAssessmentLearnerSumScore']
                            }} / {{ $gradeComputation['totalScoreCount_post_assessment'] }} ] x 100 ] x 30% = {{
                            $gradeComputation['postAssessmentScoreGrade'] }}%</p>

                        <h1 class="text-xl font-bold text-green-600">Overall Grade</h1>
                        <p class="py-5 mx-16 text-xl font-bold text-green-600">{{ $gradeComputation['activityGrade'] }}
                            + {{ $gradeComputation['quizGrade'] }} + {{$gradeComputation['postAssessmentScoreGrade']}} =
                            {{ $gradeComputation['totalGrade'] }}%</p>


                        <hr class="my-6 border-t-2 border-gray-300">
                        <h1 class="text-2xl font-bold">Final Grade: <span
                                class="text-green-600">{{$gradeComputation['totalGrade']}}%</span></h1>
                        <h1 class="text-2xl font-bold">Remarks: <span
                                class="text-green-600">{{$gradeComputation['remarks']}}</span></h1>
                    </div>
                </div>
            </div>
                ...
                <div class="m-5 px-5 overflow-auto overflow-x-auto h-[200px]">
                    <table id="gradesheet" class="table-fixed w-[3000px]">
                        <thead class="px-3 text-center text-white bg-darthmouthgreen">
                            ...
                            <th class="w-4/12">Pre Assessment ({{$gradeComputation['totalScoreCount_pre_assessment']}})
                            </th>
                            ...
                            <th class="w-4/12">Post Assessment
                                ({{$gradeComputation['totalScoreCount_post_assessment']}})</th>
        ...
        <div class="flex p-10 mt-5" id="preAssessmentData">
            <div class="w-full h-[150px] ml-5 border-2 overflow-y-auto border-darthmouthgreen"
                ...
                <table>
                    ...
                    <tbody class="text-lg text-center">
                        <tr>
                            ...
                            <td>{{$learnerPreAssessmentData->score}} /
                                ({{$gradeComputation['totalScoreCount_pre_assessment']}})</td>
                ...
                <table>
                    ...
                    <tbody class="text-lg text-center">
                        ...
                        <tr>
                            ...
                            <td>{{$postAssessment->score}} / ({{$gradeComputation['totalScoreCount_post_assessment']}})
                            </td>
        ...
        <div class="flex p-10 mt-5 w-11/12 mx-auto h-[300px] border-2 border-darthmouthgreen  overflow-y-scroll"
            id="learnerSyllabusProgressTable">
                ...
                <div class="ml-5 w-1/2 h-[350px] flex flex-col justify-between" id="learnerLessonProgressChartTable">
                    ...
                    <div class="border-2 h-[230px] border-darthmouthgreen overflow-y-scroll" style="max-height: 230px;">
                        <table class="w-full table-fixed">
                            ...
                            <tbody class="overflow-y-auto text-sm text-center learnerLessonProgressRowData"
                    ...
                    <div class="flex items-center px-10 py-3 mt-3 border-2 border-darthmouthgreen">
                        ...
                        <p class="flex items-center mx-5 mt-3 text-xl font-bold"><span
                                class="text-darthmouthgreen text-[50px] mr-5"
                                id="averageLearnerLessonProgress">0</span>Average Time of Completion</p>
                    </div>
                </div>

            </div>

            <div class="w-full mt-5 h-[350px] ml-5 border-2 border-darthmouthgreen"
                id="learnerLessonProgressLineChartArea">
        ...
        <div class=" px-7" id="learnerActivityProgressChartContainer">
            <div class="flex justify-between">
                ...
                <div class="w-1/2 h-[350px] ml-5 border-2 border-darthmouthgreen overflow-y-scroll"
                    id="learnerActivityProgressChartTable">
            ...
            <div class="flex justify-between">
                <div class="w-full mt-5 h-[350px] ml-5 border-2 border-darthmouthgreen"
                    id="learnerActivityProgressLineChartArea">
                    <canvas id="learnerActivityProgressLineChart"></canvas>
                </div>
                <div class="w-1/3 mt-5 h-[350px] ml-5 border-2 border-darthmouthgreen"
                    id="learnerActivityProgressRemarksChartArea">
        ...
        <div class=" px-7" id="learnerQuizProgressChartContainer">
            <div class="flex justify-between">
                ...
                <div class="w-2/3 h-[350px] ml-5 border-2 overflow-y-auto border-darthmouthgreen"
                    id="learnerQuizProgressChartTable">
                    <table>
                        <thead class="py-3 text-white text-md bg-darthmouthgreen">
            ...
            <div class="flex justify-between">
                <div class="w-2/3 mt-5 h-[350px] ml-5 border-2 border-darthmouthgreen"
                    id="learnerQuizProgressLineChartArea">
                    <canvas id="learnerQuizProgressLineChart"></canvas>
                </div>
                <div class="w-1/3 mt-5 h-[350px] ml-5 border-2 border-darthmouthgreen"
                    id="learnerQuizProgressRemarksChartArea">
