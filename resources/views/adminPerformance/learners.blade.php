            ...
            <div class="flex items-center justify-end space-x-3">
                ...
                <form action="{{ url('/admin/performance/learners') }}" method="GET"
                    ...
                    <input type="date" name="filterDate"
                        class="w-40 px-2 py-1 text-base border border-black rounded-xl">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/admin/performance/learners/view/{{ $learner->learner_id }}"
                                    class="px-4 py-2 text-lg font-medium text-white bg-green-600 rounded-xl hover:bg-green-700">View</a>
