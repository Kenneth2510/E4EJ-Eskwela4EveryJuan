...
<section class="flex flex-row w-screen text-sm main-container bg-mainwhitebg md:text-base">
    ...
    <section class="w-screen px-2 pt-[40px] mx-2 mt-2  overscroll-auto md:overflow-auto">
        ...
        <div class="mt-10">
            ...
            <h1 class="mx-5 text-2xl font-semibold">{{$courseData->course_name}} Quiz Overview</h1>
            ...
            <div class="w-1/2 mx-3 h-[300px] border-2 border-darthmouthgreen" id="totalLearnerProgressCount">
                <div class="flex justify-center mx-10 mt-10 text-center h-2/3 item-center">
                    ...
                    <p class="mx-5 mt-3 text-2xl font-bold py-14"><span class="text-darthmouthgreen text-[125px]"
                            id="totalLearnerSyllabusCompleteStatus">0</span><br>Learners Completed</p>
                </div>
                <div class="flex justify-center mt-5">
                    ...
                    <div class="flex items-center mx-1">
                        ...
                        <p class="font-bold text-md">IN PROGRESS: <span id="totalLearnerSyllabusInProgressStatus"
                                class="">0</span></p>
                    </div>

                    <div class="flex items-center mx-1">
                        <div class="w-3 h-3 mx-2 bg-red-700 rounded-full"></div>
                        <p class="font-bold text-md">NOT YET STARTED: <span id="totalLearnerSyllabusNotYetStatus"
                                class="">0</span></p>
                    </div>
                </div>
            </div>
        ...
        <div class="flex justify-between px-7" id="learnerSyllabusChartsArea">
            ...
            <div class="w-1/3 h-[350px] ml-5 border-2 border-darthmouthgreen"
                id="learnerSyllabusAttemptNumberChartArea">
        ...
        <h1 class="mx-5 mb-5 text-2xl">Quiz Outputs</h1>
        ...
        <h1 class="mx-5 mb-5 text-2xl">Quiz Content</h1>
        <div class="justify-between px-7" id="learnerSyllabusQuizOutputArea">

            {{-- <div class="flex">
                <div class="w-2/3 h-[350px] ml-5 border-2 border-darthmouthgreen learnerSyllabusQuizContentOutputArea"
                    id="">
