...
@section('content')
    ...
    <section class="w-full h-auto md:h-screen md:w-3/4 lg:w-10/12">
        <div class="h-full px-2 py-4 pt-24 rounded-lg shadow-lg md:overflow-hidden md:overflow-y-scroll md:pt-0">
            ...
            <div class="flex flex-col justify-between space-y-4 lg:flex-row lg:space-x-2 lg:space-y-0" id="learnerCourseProgressArea">
                <div class="md:w-3/5 lg:h-[350px] border-2 border-darthmouthgreen" id="learnerCourseProgressChart">
                    <canvas id="learnerCourseDataChart"></canvas>
                </div>

                <div class="md:w-2/5 lg:h-[350px] border-2 border-darthmouthgreen overflow-auto" id="learnerCourseListArea">
            ...
            <!--    <div class="w-full lg:h-[400px] border-2 border-darthmouthgreen" id="learnerCourseTopicProgressChart">-->
            <!--        <canvas id="learnerTopicDataChart"></canvas>-->
            <!--    </div>-->

            <!--    <div class="flex flex-col w-full mt-5" id="learnerCourseTopicProgressTable">-->
            <!--        <a href="" method="GET" class="text-lg text-right underline text-darthmouthgreen hover:text-green-950">view more details</a>-->
            <!--        <div class="overflow-auto">-->
            <!--            <table id="learnerSyllabusTable" class="w-full mt-5 table-auto table">-->
            <!--                <thead class="text-white bg-darthmouthgreen">-->
