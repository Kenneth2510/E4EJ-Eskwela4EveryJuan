...
<section class="w-full h-screen md:w-3/4 lg:w-10/12">
    <div class="h-full px-2 py-4 pt-24 rounded-lg shadow-lg md:overflow-hidden md:overflow-y-scroll md:pt-0">
        ...
        <div class="py-4" id="welcome">
            <h1 class="text-2xl font-semibold md:text-3xl">Welcome back, Instructor <span
                    class="text-darthmouthgreen">{{$instructor->instructor_fname}}</span>!</h1>
        </div>
                        ...
                        {{-- <tr>
                            ...
                            <td>
                                <div class="h-7 rounded-xl" style="background: #9DB0A3" id="skill_bar">
                                    <div class="relative py-1 text-center text-white h-7 bg-darthmouthgreen rounded-xl"
                                        id="skill_per" per="70%" style="max-width: 70%">70%</div>
                                </div>
                            </td>
                        </tr> --}}
                    </tbody>
