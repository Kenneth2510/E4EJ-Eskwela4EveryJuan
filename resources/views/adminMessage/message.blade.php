...
<section class="w-full h-screen md:w-3/4 lg:w-10/12">
    <div class="h-full px-2 py-4 pt-24 overflow-auto rounded-lg shadow-lg md:pt-6">
        <div class="flex items-center justify-between p-3 md:py-8">
            <h1 class="text-2xl font-bold text-darthmouthgreen md:text-3xl lg:text-4xl">Message</h1>
            <div class="">
        ...
        <div class="flex flex-col lg:flex-row" id="upper_container">
            <div class="w-full py-10 overflow-y-auto bg-white shadow-lg lg:w-3/12 lg:max-h-[550px]"
    ...
    <div class="w-full p-4 overflow-auto bg-white rounded-lg shadow-lg modal-content h-3/4 md:w-3/5">
        ...
        <div class="mt-4">
            ...
            <input type="text" name="subject" id="subject"
                class="block w-full input input-bordered input-primary focus:input-primary">
            <span id="subjectError" class="text-red-500"></span>
        </div>

        <div class="mt-4">
            <label for="messageContent" class="text-lg font-semibold">Enter Message</label>
            <textarea name="createNewMessageArea" id="createNewMessageArea" class="block w-full input input-bordered"
        ...
        <div class="mt-4">
            ...
            <input type="file" name="attachments" id="attachments"
                class="block w-full file-input file-input-bordered file-input-primary" multiple
                onchange="checkTotalFileSize(this)">
            <script>
        ...
        <div class="flex justify-center w-full mt-5 space-x-2">
            ...
            <button id="" class="btn btn-error">Cancel</button>
        </div>
    </div>
</div>
...
<div id="selectRecipientsModal"
    class="fixed z-[98] top-0 left-0 flex items-center justify-center hidden w-full h-full bg-gray-200 bg-opacity-75">
    <div class="modal-content bg-white p-4 rounded-lg shadow-lg w-[750px]">
        ...
        <input type="text" name="recipientName" id="recipientName"
            class="w-full input input-bordered input-primary focus:input-primary" placeholder="Enter email">
        ...
        <div class="flex justify-center w-full mt-5 space-x-2">
            <button id="confirmRecipientsBtn" class="btn btn-primary">Add</button>
            <button id="" class="btn btn-error closeSelectRecipientsModal">Cancel</button>
        </div>
    </div>
</div>
