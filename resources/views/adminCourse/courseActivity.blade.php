        ...
        <div class="p-3 pb-4 overflow-auto rounded-lg shadow-lg b overscroll-auto">
            <div style="background-color:{{$mainBackgroundCol}}" class="p-2 text-white fill-white rounded-xl">
                ...
                <div class="flex flex-col fill-mainwhitebg">
                    <h1 class="w-1/2 py-4 text-4xl font-bold"><span class="">{{ $activityInfo->activity_title }}</span>
                    </h1>
                </div>
            </div>
            ...
            <div class="mx-2">
                ...
                <div class="py-4 " id="defaultView">
                    ...
                    {{-- <input type="text" name="activity_instructions"
                        class="w-full max-w-full min-w-full activity_instructions"
                        value="{{$activity->activity_instructions}}" disabled> --}}

                    <textarea name="activity_instructions"
                        class="w-full max-w-full min-w-full activity_instructions max-h-[200px]"
                        disabled>{{$activityContent->activity_instructions}}</textarea>
                    <span class="text-lg text-red-500">Please make sure to edit and add your activity question</span>
                    <div class="hidden mt-3 editInstructions_clickedBtn">
                        <button
                            class="px-3 py-3 text-white bg-green-600 saveInstructionsBtn hover:bg-green-900 rounded-xl">Save</button>
                        <button
                            class="px-3 py-3 text-white bg-red-600 cancelInstructionsBtn hover:bg-red-900 rounded-xl">Cancel</button>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="flex justify-end">
                                    <input type="text" class="flex w-full text-center" value="{{ $criteria->score }}"
                                        disabled>
                                </td>
                                <td>
                                    <button
                                        class="hidden px-3 py-1 mx-2 font-semibold text-white bg-green-600 rounded-xl editCriteriaBtn hover:bg-green-900">Edit</button>
                                    <div class="flex edit_btns">
                                        <button
                                            class="hidden px-3 py-1 mx-2 font-semibold text-white bg-green-600 rounded-xl saveCriteriaBtn hover:bg-green-900">Save</button>
                                        <button
                                            class="hidden px-3 py-1 mx-2 font-semibold text-white bg-red-600 rounded-xl deleteCriteriaBtn hover:bg-red-900">Delete</button>
                                        <button
                                            class="hidden px-3 py-1 mx-2 font-semibold text-white bg-red-600 rounded-xl cancelCriteriaBtn hover:bg-red-900">Cancel</button>
                                    </div>
                                </td>
                            </tr>
                            @empty
                    ...
                    <span class="text-lg text-red-600">Please make sure to edit and add the activity criteria</span>
                    <button id="addNewCriteria"
                        class="hidden px-3 py-1 mx-2 font-semibold text-white bg-darthmouthgreen rounded-xl hover:bg-green-900">Add
                        Criteria</button>
                    <div class="hidden mt-3" id="editCriteria_clickedBtn">
                        <button id="saveCriteriaBtn"
                            data-activity-content-id="{{$activityContent->activity_content_id}}"
                            class="p-3 text-white rounded-xl bg-darthmouthgreen hover:bg-green-900">Save
                            Criteria</button>
                        <button id="cancelCriteriaBtn"
                            class="p-3 text-white bg-red-600 hover:bg-red-900 rounded-xl">Cancel</button>
                    </div>
                    <br>
                    <br>
                    <br>
                    <div class="">
                        ...
                        <input type="number" id="overallScore_input py-5 px-5 border-2 border-green-400"
                            class="w-full text-4xl" value="{{$activityContent->total_score}}" disabled>
                        <p class="px-10 text-4xl">/ {{$activityContent->total_score}}</p>
                        <div class="hidden mt-3" id="editTotalScore_clickedBtn">
                            <button id="saveTotalScoreBtn"
                                class="px-5 py-3 text-white rounded-xl bg-darthmouthgreen hover:bg-green-900">Save
                                Score</button>
                            <button id="cancelTotalScoreBtn"
                                class="px-5 py-3 text-white bg-red-600 hover:bg-red-900 rounded-xl">Cancel</button>
                        </div>
                    </div>
                ...
                <div class="my-2" id="studentsList" data-course-id="{{$activityInfo->course_id}}"
                    data-syllabus-id="{{$activityInfo->syllabus_id}}">
                </div>
            ...
            <div class="flex justify-between">
                <button id="editActivityBtn"
                    class="w-1/2 h-16 px-5 py-3 mx-3 text-white bg-darthmouthgreen hover:bg-green-900 rounded-xl"
                    data-course-id="{{$course->course_id}}"
                    data-syllabus-id="{{$activityInfo->syllabus_id}}">Edit</button>
                <div class="hidden w-1/2 h-16 mx-5" id="editActivity_clickedBtns">
                    <button id="saveActivityBtn"
                        class="w-full h-16 px-5 py-3 text-white bg-darthmouthgreen hover:bg-green-900 rounded-xl">Finish
                        Editing</button>
                </div>
                <button id="viewResponseActivity"
                    class="w-1/2 h-16 px-5 py-3 mx-3 text-white bg-darthmouthgreen hover:bg-green-900 rounded-xl"
                    data-course-id="{{$course->course_id}}" data-syllabus-id="{{$activityInfo->syllabus_id}}">View
                    Responses</button>
            ...
            <table class="w-full">
                ...
                <tbody id="responsesRowDataArea" class="">
                    {{-- <tr class="text-center">
                        ...
                        <td>
                            <button
                                class="px-5 py-3 text-white bg-darthmouthgreen hover:bg-green-950 rounded-xl">View</button>
                        </td>
                    </tr> --}}
                </tbody>
            </table>
