...
<section class="w-screen px-2 pt-[40px] mx-2 mt-2  overscroll-auto md:overflow-auto">
    ...
    <div class="w-full text-center" id="">
        <a href="{{ url("/admin/courseManage/content/$quizData->course_id/$quizData->syllabus_id/quiz")}}" class="px-5 py-3 text-lg text-white rounded-lg bg-darthmouthgreen hover:bg-green-950">Return</a>
    </div>
