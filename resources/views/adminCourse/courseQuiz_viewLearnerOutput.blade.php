...
<section class="flex flex-row w-screen text-sm main-container bg-mainwhitebg md:text-base">
    ...
    <section class="w-screen px-2 pt-[40px] mx-2 mt-2  overscroll-auto md:overflow-auto">
        ...
        <div class="flex justify-between mt-5">
            <h1 class="mx-2 text-4xl font-semibold">{{$learnerQuizOutputData->learner_fname}}
                {{$learnerQuizOutputData->learner_lname}}'s Output</h1>
            <div class="">
        ...
        <div class="flex mt-5">
            <div class="w-2/6 border-r-2 border-green-200 px-auto" id="quiz_info_area">
                ...
                <div class="px-5 mt-5">Attempt Taken on: <span
                        class="font-semibold">{{$learnerQuizOutputData->updated_at}}</span></div>
        ...
        <div class="w-full text-center" id="">
            <a href="{{ url("/admin/courseManage/content/$quizData->course_id/$quizData->syllabus_id/quiz")}}"
                class="px-5 py-3 text-lg text-white rounded-lg bg-darthmouthgreen hover:bg-green-950">Return</a>
        </div>
