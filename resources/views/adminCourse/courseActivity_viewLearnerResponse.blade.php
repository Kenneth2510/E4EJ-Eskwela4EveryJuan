    ...
    <div class="mx-2">
        ...
        <div class="py-4 " id="defaultView">
            ...
            <div class="p-6 bg-gray-100 shadow-md rounded-xl">
                ...
                @else
                    <div class="my-5">
                        <a href="{{ url("/admin/courseManage/content/$activity->course_id/$activity->syllabus_id/activity/$learnerActivityOutput_2nd->learner_course_id/$learnerActivityOutput_2nd->attempt") }}"  class="px-5 py-3 text-lg font-semibold text-white bg-darthmouthgreen hover:bg-green-950 rounded-xl">View Second Attempt</a>
                    </div>
                @endif
        ...
        <div class="flex justify-between w-full px-3 mx-3">
            <a id="returnBtn" href="/admin/courseManage/content/{{$activity->course_id}}/{{$activity->syllabus_id}}}/activity" class="w-1/2 px-5 py-5 mx-2 text-xl text-center text-white bg-green-700 rounded-xl hover:bg-green-900">Return</a>
