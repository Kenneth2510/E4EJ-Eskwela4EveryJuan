                ...
                <div id="lesson_title_area" class="mb-4">
                    <div class="flex items-center justify-between pb-3 my-4 mt-5 border-b-2 border-seagreen">
                        ...
                        <div id="edit_lesson_btns" class="hidden">
                            <button id="save_lesson_btn" data-lesson-id="{{$lessonInfo->lesson_id}}" data-course-id="{{$lessonInfo->course_id}}" data-syllabus-id="{{$lessonInfo->syllabus_id}}" class="px-5 py-3 text-white rounded-xl bg-darthmouthgreen hover:bg-green-800">
                                Save
                            </button>
                            <button id="cancel_lesson_btn" class="px-5 py-3 text-white rounded-xl bg-darthmouthgreen hover:bg-green-800">
                                Cancel
                            </button>
                        </div>
                    </div>
                ...
                <div class="mt-5">
                    ...
                    <div id="lesson_img" class="flex justify-center w-full h-[400px] my-4 rounded-lg shadow">
                        ...
                        <div id="edit_lesson_picture_btns" style="position: relative; top: 75%;" class="flex justify-end hidden">
                            <button id="" data-lesson-id="{{$lessonInfo->lesson_id}}" data-course-id="{{$lessonInfo->course_id}}"  data-syllabus-id="{{$lessonInfo->syllabus_id}}" class="flex px-5 py-3 mr-3 text-white add_lesson_picture_btn rounded-xl bg-darthmouthgreen hover:bg-green-800">
                                Change Photo
                            </button>
                        </div>
                        @else
                        ...
                        <div class="z-50 w-11/12 mx-auto overflow-y-auto bg-white rounded shadow-lg modal-container md:max-w-md">
                            <div class="px-6 py-4 text-left modal-content">
                                ...
                                <div class="mb-4">
                                    ...
                                    <form id="pictureUploadForm" data-lesson-id="{{$lessonInfo->lesson_id}}" data-course-id="{{$lessonInfo->course_id}}" data-syllabus-id="{{$lessonInfo->syllabus_id}}" enctype="multipart/form-data">
                    ...
                    <div id="main_content_area" class="">
                        ...
                        <div data-content-order="{{$lesson->lesson_content_order}}" class="w-full px-10 my-2 mb-8 lesson_content_area">
                            ...
                            <div class="flex justify-end hidden w-full edit_lesson_content_btns">
                                <button id="" class="px-5 py-3 mx-1 text-white save_lesson_content_btn rounded-xl bg-darthmouthgreen hover:bg-green-800">
                                    Save
                                </button>
                                <button id="" class="px-5 py-3 mx-1 text-white bg-red-600 delete_lesson_content_btn rounded-xl hover:bg-red-800">
                                    Delete
                                </button>
                                <button id="" class="px-5 py-3 mx-1 text-white cancel_lesson_content_btn rounded-xl bg-darthmouthgreen hover:bg-green-800">
                                    Cancel
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="flex justify-center w-full">
                        <button id="editLessonBtn" data-course-id="{{$lessonInfo->course_id}}" data-syllabus-id="{{$lessonInfo->syllabus_id}}"
                        onmouseout="this.style.backgroundColor='#025c26'" class="w-1/2 py-5 mx-1 mt-4 text-xl text-white rounded-lg shadow-lg bg-seagreen hover:bg-green-800 hover:text-white">
                            <h1>Edit</h1>
                        </button>
                        <div id="editBtns" class="flex justify-end hidden w-full">
                            <button id="cancelEditBtn" class="w-1/2 py-5 mx-1 mt-4 text-xl text-white rounded-lg shadow-lg bg-darthmouthgreen hover:bg-green-800 bg-seagreen hover:text-white">
                                <h1>Cancel</h1>
                            </button>
                            <button id="saveEditBtn" class="w-1/2 py-5 mx-1 mt-4 text-xl text-white rounded-lg shadow-lg bg-darthmouthgreen hover:bg-green-800 bg-seagreen hover:text-white" data-lesson-id="{{$lessonInfo->lesson_id}}" data-course-id="{{$lessonInfo->course_id}}" data-syllabus-id="{{$lessonInfo->syllabus_id}}">
...
<div id="deleteLessonContentUrlModal" class="fixed top-0 left-0 flex items-center justify-center hidden w-screen h-screen bg-black bg-opacity-50">
    {{-- <form id="deleteCourse" action="" data-course-id="{{ $course->course_id }}"> --}}
        ...
        <div class="p-5 text-center bg-white rounded-lg">
            <p>Are you sure you want to delete this content?</p>
            <button type="button" id="confirmDelete_lessonContentUrl" data-content-order="" data-lesson-content-id="" data-lesson-id="" data-course-id="{{$course->course_id}}" data-syllabus-id="{{$lessonInfo->syllabus_id}}"  class="px-4 py-2 m-2 text-white bg-red-600 rounded-md">Confirm</button>
...
<div id="loaderModal" class="fixed top-0 left-0 z-[90] flex items-center justify-center hidden w-full h-full bg-gray-200 bg-opacity-75 ">
