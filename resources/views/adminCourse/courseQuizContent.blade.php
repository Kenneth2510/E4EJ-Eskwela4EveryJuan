...
<section class="flex flex-row w-screen text-sm main-container bg-mainwhitebg md:text-base">
    ...
    <section class="w-screen px-2 pt-[40px] mx-2 mt-2  overscroll-auto md:overflow-auto">
        ...
        <div class="flex flex-row items-center justify-between py-4 border-b-2">
            ...
            <button
                class="px-5 py-3 text-lg font-medium text-white saveQuizContent bg-darthmouthgreen rounded-2xl hover:bg-green-950">Save
                Changes</button>
        ...
        <div class="w-full mt-10 quizContentArea">
            ...
            <div class="flex justify-center w-full py-5 quizOptions">
                <button class="px-5 py-5 mx-3 text-white rounded-xl bg-darthmouthgreen hover:bg-green-950 w-max"
                    id="addExistingQuestionBtn">
            ...
            <div class="flex justify-center w-full py-5 mt-5 border-t-2 border-gray-400">
                ...
                <a id="cancelQuizBuild" href="{{ url("/admin/courseManage/content/$course->course_id/$quizInfo->syllabus_id/quiz") }}" class="w-1/2 px-5
                    py-3 mx-3 text-lg font-medium text-center text-white bg-darthmouthgreen rounded-2xl
                    hover:bg-green-950">
                    Cancel
                </a>
                <button
                    class="w-1/2 px-5 py-3 mx-3 text-lg font-medium text-white saveQuizContent bg-darthmouthgreen rounded-2xl hover:bg-green-950">
                    Save Changes
                </button>
            </div>
        </div>
...
<div id="addExistingQuestionModal"
    ...
    <div class="modal-content bg-white p-4 rounded-lg shadow-lg w-[500px]">
        ...
        <div class="flex justify-center w-full mt-5">
            <button id="confirmAddExistingQuestionBtn"
                class="px-4 py-2 mx-2 mt-4 text-white rounded bg-seagreen hover:bg-darkenedColor">Confirm</button>
            <button id=""
                class="px-4 py-2 mx-2 mt-4 text-white bg-red-500 rounded cancelAddExistingQuestionBtn">Cancel</button>
        </div>
...
<div id="confirmSaveQuizContentModal"
    class="fixed top-0 left-0 flex items-center justify-center hidden w-full h-full bg-gray-200 bg-opacity-75">
    <div class="modal-content bg-white p-4 rounded-lg shadow-lg w-[500px]">
        <div class="flex justify-end w-full">
        ...
        <div class="flex justify-center w-full mt-5">
            <button id="confirmSaveQuizContentBtn"
                class="px-4 py-2 mx-2 mt-4 text-white rounded bg-seagreen hover:bg-darkenedColor">Confirm</button>
            <button id=""
                class="px-4 py-2 mx-2 mt-4 text-white bg-red-500 rounded cancelSaveQuizContentBtn">Cancel</button>
        </div>
    </div>
</div>
