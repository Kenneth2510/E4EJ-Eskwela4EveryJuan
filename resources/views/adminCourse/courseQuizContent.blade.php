...
<section class="w-screen px-2 pt-[40px] mx-2 mt-2  overscroll-auto md:overflow-auto">
    ...
    <div class="w-full mt-10 quizContentArea">
        ...
        <div class="flex justify-center w-full py-5 mt-5 border-t-2 border-gray-400">
            ...
            <a id="cancelQuizBuild" href="{{ url("/admin/courseManage/content/$course->course_id/$quizInfo->syllabus_id/quiz") }}" class="w-1/2 px-5 py-3 mx-3 text-lg font-medium text-center text-white bg-darthmouthgreen rounded-2xl hover:bg-green-950">
            Cancel
            </a>
