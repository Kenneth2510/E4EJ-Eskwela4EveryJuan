    ...
    <section class="w-screen px-2 pt-[40px] mx-2 mt-2  overscroll-auto md:overflow-auto">
        ...
        <div class="py-4 " id="defaultView">
            ...
            <div id="coverageArea" class="mt-5">
                <table class="w-full">
                    ...
                    <tbody class="referenceTable">
                        ...
                        <tr>
                            ...
                            <td class="w-1/5">
                                <button
                                    class="hidden px-3 py-1 mx-2 font-semibold text-white bg-green-600 rounded-xl editReferenceBtn hover:bg-green-900">Edit</button>
                                <div class="flex hidden editReference_clickedBtns">
                                    <button
                                        class="px-3 py-1 mx-2 font-semibold text-white bg-green-600 rounded-xl saveReferenceBtn hover:bg-green-900">Save</button>
                                    <button
                                        class="px-3 py-1 mx-2 font-semibold text-white bg-red-600 rounded-xl deleteReferenceBtn hover:bg-red-900">Delete</button>
                                    <button
                                        class="px-3 py-1 mx-2 font-semibold text-white bg-red-600 rounded-xl cancelReferenceBtn hover:bg-red-900">Cancel</button>
                                </div>
                            </td>
                        </tr>
                        @empty
                ...
                <button id="addNewReference"
                    class="hidden px-5 py-3 my-5 text-white rounded-xl bg-darthmouthgreen hover:bg-green-900">Add
                    Reference</button>
                <div class="hidden my-5 mt-3" id="addNewReference_clickedBtns">
                    <button id="saveAddNewReferenceBtn"
                        class="px-5 py-3 text-white rounded-xl bg-darthmouthgreen hover:bg-green-900">Save
                        Reference</button>
                    <button id="cancelAddNewReferenceBtn"
                        class="px-5 py-3 text-white bg-red-600 hover:bg-red-900 rounded-xl">Cancel</button>
                </div>
            </div>
            <span id="" class="text-red-600">Make sure to add the references before going to the editor</span>
            ...
            <div class="mt-16" id="durationArea">
                ...
                <div class="">
                    ...
                    <input disabled class="w-1/12 px-1 mx-3 text-lg border-2 border-gray-400 rounded-lg duration_input"
                        type="number" id="hours" name="hours" min="0" placeholder="0" value="0" required>

                    <label class="text-lg" for="minutes">Minutes:</label>
                    <input disabled class="w-1/12 px-1 mx-3 text-lg border-2 border-gray-400 rounded-lg duration_input"
                        type="number" id="minutes" name="minutes" min="0" max="59" placeholder="0" value="30" required>

                    <label class="text-lg" for="seconds">Seconds:</label>
                    <input disabled class="w-1/12 px-1 mx-3 text-lg border-2 border-gray-400 rounded-lg duration_input"
                        type="number" id="seconds" name="seconds" min="0" max="59" placeholder="0" value="0" required>

                    <button id="saveDurationBtn"
                        class="hidden px-3 py-1 text-lg text-white bg-darthmouthgreen hover:bg-green-950 rounded-xl">Set
                        Duration</button>
                </div>
            </div>


            {{-- <button id="editQuizInfoBtn"
                class="w-32 px-5 py-3 mx-3 mt-10 text-white bg-darthmouthgreen hover:bg-green-900 rounded-xl">Edit</button>
            --}}
            <div class="my-8 space-x-2">
                <span id="" class="text-red-600">Make sure to set the duration time before going to the editor</span>
                <button id="editQuizInfoBtn" class="btn btn-primary">Edit</button>
            </div>

            <div class="hidden mt-5" id="editQuizInfo_clickedBtns">
                <button id="saveQuizInfoBtn"
                    class="px-6 py-4 mx-3 text-xl text-white bg-darthmouthgreen hover:bg-green-900 rounded-xl">Finish
                    Editing</button>
            </div>
            <div class="flex w-full mt-5">
                <button id="viewResponsesBtn"
                    class="w-1/2 px-5 py-5 mx-3 mt-3 text-white bg-darthmouthgreen hover:bg-green-900 rounded-xl">
                    View Responses
                </button>
                <a href="{{ url("/admin/courseManage/content/$quizInfo->course_id/$quizInfo->syllabus_id/quiz/$quizInfo->quiz_id/content")
                    }}" class="w-1/2 px-5 py-5 mx-3 mt-3 text-center text-white bg-darthmouthgreen hover:bg-green-900
                    rounded-xl">
                    Enter Quiz Editor
                </a>
            </div>
