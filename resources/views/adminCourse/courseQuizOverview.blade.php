    ...
    <div class="py-4 " id="defaultView">      
        ...
        <div class="flex flex-row items-center">
            ...
            <div class="flex w-full mt-5">
                ...
                <a href="{{ url("/admin/courseManage/content/$quizInfo->course_id/$quizInfo->syllabus_id/quiz/$quizInfo->quiz_id/content") }}" class="w-1/2 px-5 py-5 mx-3 mt-3 text-center text-white bg-darthmouthgreen hover:bg-green-900 rounded-xl">
                    Enter Quiz Editor
                </a>
            </div>
