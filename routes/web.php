...
Route::namespace('App\Http\Controllers')->group(function () {
    ...
    // lesson management
    Route::get('/admin/courseManage/content/{course}/{syllabus}/lesson', 'AdminCourseManageController@view_lesson');
    Route::get('/admin/courseManage/content/{course}/{syllabus}/lesson/json', 'AdminCourseManageController@lesson_content_json');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/lesson/addCompletionTime', 'AdminCourseManageController@addCompletionTime');

    Route::post('/admin/courseManage/content/{course}/{syllabus}/lesson/title/{lesson_id}', 'AdminCourseManageController@update_lesson_title');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/lesson/title/{lesson}/picture', 'AdminCourseManageController@update_lesson_picture');
    ...
    Route::post('/admin/courseManage/content/{course}/{syllabus}/lesson/title/{lesson}/save', 'AdminCourseManageController@save_lesson_content');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/lesson/title/{lesson}/save_add', 'AdminCourseManageController@save_add_lesson_content');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/lesson/title/{lesson}/store_file/{lesson_content}', 'AdminCourseManageController@lesson_content_store_file');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/lesson/title/{lesson}/delete_file/{lesson_content}', 'AdminCourseManageController@lesson_content_delete_file');
    Route::get('/admin/courseManage/content/{course}/{syllabus}/lesson/pdf_view', 'AdminCourseManageController@view_lesson_pdf');
    Route::get('/admin/courseManage/content/{course}/{syllabus}/lesson/title/{lesson}/generate_pdf', 'AdminCourseManageController@lesson_generate_pdf');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/lesson/title/{lesson}/store_video_url/{lesson_content}', 'AdminCourseManageController@lesson_content_embed_url');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/lesson/title/{lesson}/delete_url/{lesson_content}', 'AdminCourseManageController@lesson_content_delete_url');
    
    // activity management
    Route::get('/admin/courseManage/content/{course}/{syllabus}/activity', 'AdminCourseManageController@view_activity');
    Route::get('/admin/courseManage/content/{course}/{syllabus}/activity/json', 'AdminCourseManageController@activity_content_json');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/activity/title/{activity}/{activity_content}/instructions', 'AdminCourseManageController@update_activity_instructions');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/activity/title/{activity}/{activity_content}/score', 'AdminCourseManageController@update_activity_score');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/activity/title/{activity}/{activity_content}/criteria', 'AdminCourseManageController@update_activity_criteria');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/activity/title/{activity}/{activity_content}/criteria_add', 'AdminCourseManageController@add_activity_criteria');

    Route::get('/admin/courseManage/content/{course}/{syllabus}/activity/{learner_course}/{attempt}', 'AdminCourseManageController@view_learner_activity_response');
    ...
    // quiz management
    Route::get('/admin/courseManage/content/{course}/{syllabus}/quiz', 'AdminCourseManageController@view_quiz');
    Route::get('/admin/courseManage/content/{course}/{syllabus}/quiz/json', 'AdminCourseManageController@quiz_info_json');
    Route::get('/admin/courseManage/content/{course}/{syllabus}/quiz/view_learner_output/{learner_quiz_progress}', 'AdminCourseManageController@view_learner_output');
    Route::get('/admin/courseManage/content/{course}/{syllabus}/quiz/view_learner_output/{learner_quiz_progress}/json', 'AdminCourseManageController@view_learner_output_json');
    
    Route::post('/admin/courseManage/content/{course}/{syllabus}/quiz/{quiz}/add', 'AdminCourseManageController@manage_add_reference');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/quiz/{quiz}/update', 'AdminCourseManageController@manage_update_reference');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/quiz/{quiz}/duration', 'AdminCourseManageController@manage_update_duration');

    Route::get('/admin/courseManage/content/{course}/{syllabus}/quiz/{quiz_id}/content', 'AdminCourseManageController@quiz_content');
    Route::get('/admin/courseManage/content/{course}/{syllabus}/quiz/{quiz_id}/content/json', 'AdminCourseManageController@quiz_content_json');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/quiz/{quiz_id}/content/add', 'AdminCourseManageController@add_quiz_question');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/quiz/{quiz_id}/content/update', 'AdminCourseManageController@update_quiz_question');
    Route::post('/admin/courseManage/content/{course}/{syllabus}/quiz/{quiz_id}/content/empty', 'AdminCourseManageController@empty_quiz_question');
...
Route::namespace('App\Http\Controllers')->group(function () {
    Route::get('/admin/reports', 'AdminReportsGeneratorController@index');
    Route::get('/admin/reports/list/learners', 'AdminReportsGeneratorController@listLearners');
    Route::get('/admin/reports/select/learner', 'AdminReportsGeneratorController@selectLearner');

    Route::get('/admin/reports/list/instructors', 'AdminReportsGeneratorController@listInstructors');
    Route::get('/admin/reports/select/instructor', 'AdminReportsGeneratorController@selectInstructor');

    Route::get('/admin/reports/list/session', 'AdminReportsGeneratorController@listSession');
    Route::get('/admin/reports/select/session', 'AdminReportsGeneratorController@selectSession');

    Route::get('/admin/reports/list/courses', 'AdminReportsGeneratorController@listCourses');
    Route::get('/admin/reports/select/course', 'AdminReportsGeneratorController@selectCourse');
    
    Route::get('/admin/reports/list/course/enrollees', 'AdminReportsGeneratorController@listCourseEnrollees');

    Route::get('/admin/reports/list/course/gradesheet', 'AdminReportsGeneratorController@listCourseGradesheet');
    Route::get('/admin/reports/select/learner/course/gradesheet', 'AdminReportsGeneratorController@listLearnerCourseGradesheet');


    Route::get('/admin/reports/search/learners', 'AdminReportsGeneratorController@searchLearner');
    Route::get('/admin/reports/search/instructors', 'AdminReportsGeneratorController@searchInstructor');
    Route::get('/admin/reports/search/course', 'AdminReportsGeneratorController@searchCourse');
    Route::get('/admin/reports/search/course/approved', 'AdminReportsGeneratorController@searchApprovedCourse');
    Route::get('/admin/reports/search/learner/course', 'AdminReportsGeneratorController@searchLearnerCourse');
});
...
Route::namespace('App\Http\Controllers')->group(function () {
    ...
    Route::get('/instructor/course/{course}/delete', 'InstructorCourseController@delete_course');
    ...
    // lesson management
    Route::get('/instructor/course/content/{course}/{syllabus}/lesson', 'InstructorCourseController@view_lesson');
    Route::get('/instructor/course/content/{course}/{syllabus}/lesson/json', 'InstructorCourseController@lesson_content_json');
    Route::post('/instructor/course/content/{course}/{syllabus}/lesson/addCompletionTime', 'InstructorCourseController@addCompletionTime');

    Route::post('/instructor/course/content/{course}/{syllabus}/lesson/title/{lesson_id}', 'InstructorCourseController@update_lesson_title');
    Route::post('/instructor/course/content/{course}/{syllabus}/lesson/title/{lesson}/picture', 'InstructorCourseController@update_lesson_picture');
    ...
    Route::post('/instructor/course/content/{course}/{syllabus}/lesson/title/{lesson}/save', 'InstructorCourseController@save_lesson_content');
    Route::post('/instructor/course/content/{course}/{syllabus}/lesson/title/{lesson}/save_add', 'InstructorCourseController@save_add_lesson_content');
    Route::post('/instructor/course/content/{course}/{syllabus}/lesson/title/{lesson}/store_file/{lesson_content}', 'InstructorCourseController@lesson_content_store_file');
    Route::post('/instructor/course/content/{course}/{syllabus}/lesson/title/{lesson}/delete_file/{lesson_content}', 'InstructorCourseController@lesson_content_delete_file');
    Route::get('/instructor/course/content/{course}/{syllabus}/lesson/pdf_view', 'InstructorCourseController@view_lesson_pdf');
    Route::get('/instructor/course/content/{course}/{syllabus}/lesson/title/{lesson}/generate_pdf', 'InstructorCourseController@lesson_generate_pdf');
    Route::post('/instructor/course/content/{course}/{syllabus}/lesson/title/{lesson}/store_video_url/{lesson_content}', 'InstructorCourseController@lesson_content_embed_url');
    Route::post('/instructor/course/content/{course}/{syllabus}/lesson/title/{lesson}/delete_url/{lesson_content}', 'InstructorCourseController@lesson_content_delete_url');
    
    // activity management
    Route::get('/instructor/course/content/{course}/{syllabus}/activity', 'InstructorCourseController@view_activity');
    Route::get('/instructor/course/content/{course}/{syllabus}/activity/json', 'InstructorCourseController@activity_content_json');
    Route::post('/instructor/course/content/{course}/{syllabus}/activity/title/{activity}/{activity_content}/instructions', 'InstructorCourseController@update_activity_instructions');
    Route::post('/instructor/course/content/{course}/{syllabus}/activity/title/{activity}/{activity_content}/score', 'InstructorCourseController@update_activity_score');
    Route::post('/instructor/course/content/{course}/{syllabus}/activity/title/{activity}/{activity_content}/criteria', 'InstructorCourseController@update_activity_criteria');
    Route::post('/instructor/course/content/{course}/{syllabus}/activity/title/{activity}/{activity_content}/criteria_add', 'InstructorCourseController@add_activity_criteria');

    Route::get('/instructor/course/content/{course}/{syllabus}/activity/{learner_course}/{attempt}', 'InstructorCourseController@view_learner_activity_response');
    ...
    // quiz management
    Route::get('/instructor/course/content/{course}/{syllabus}/quiz', 'InstructorCourseController@view_quiz');
    Route::get('/instructor/course/content/{course}/{syllabus}/quiz/json', 'InstructorCourseController@quiz_info_json');

    Route::get('/instructor/course/content/{course}/{syllabus}/quiz/view_learner_output/{learner_quiz_progress}', 'InstructorCourseController@view_learner_output');
    Route::get('/instructor/course/content/{course}/{syllabus}/quiz/view_learner_output/{learner_quiz_progress}/json', 'InstructorCourseController@view_learner_output_json');
    
    Route::post('/instructor/course/content/{course}/{syllabus}/quiz/{quiz}/add', 'InstructorCourseController@manage_add_reference');
    Route::post('/instructor/course/content/{course}/{syllabus}/quiz/{quiz}/update', 'InstructorCourseController@manage_update_reference');
    Route::post('/instructor/course/content/{course}/{syllabus}/quiz/{quiz}/duration', 'InstructorCourseController@manage_update_duration');

    Route::get('/instructor/course/content/{course}/{syllabus}/quiz/{quiz_id}/content', 'InstructorCourseController@quiz_content');
    Route::get('/instructor/course/content/{course}/{syllabus}/quiz/{quiz_id}/content/json', 'InstructorCourseController@quiz_content_json');
    Route::post('/instructor/course/content/{course}/{syllabus}/quiz/{quiz_id}/content/add', 'InstructorCourseController@add_quiz_question');
    Route::post('/instructor/course/content/{course}/{syllabus}/quiz/{quiz_id}/content/update', 'InstructorCourseController@update_quiz_question');
    Route::post('/instructor/course/content/{course}/{syllabus}/quiz/{quiz_id}/content/empty', 'InstructorCourseController@empty_quiz_question');
