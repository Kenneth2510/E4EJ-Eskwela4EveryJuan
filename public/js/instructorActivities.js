$(document).ready(() => {
    ...
    function activityOutputData() {
        ...
        var url = "/instructor/course/content/"+ courseID +"/"+ syllabusID +"/activity/json";
                    ...
                    learnerRowData += `
                        <tr>
                            ...
                            <td class="float-right">
                                <a href="/instructor/course/content/${courseID}/${syllabusID}/activity/${enrollee_id}/${attempt}" 
    ...
    $('.cancelCriteriaBtn').on('click', function(e) {
        ...
        $('.edit_btns').addClass('hidden');
        $('.editRowCriteriaBtn ').addClass('hidden')
    })
...
// Handle saving the criteria and score to your array (activityCriteriaData)
    ...
    $('#saveActivityBtn').on('click', function(e) {
        ...
        $('.deleteNewCriteriaBtn').closest('tr').remove();
