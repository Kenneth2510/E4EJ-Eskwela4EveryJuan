$(document).ready(function () {
    ...
    $("#reportCategory").on("change", function (e) {
        ...
        $(
            "#listLearnerArea , #selectedLearnerArea ,#listInstructorArea ,#selectedInstructorArea ,#sessionLogsArea ,#selectedSessionLogsArea ,#listCourseArea ,#selectedCourseArea ,#listCourseEnrolleesArea ,#courseGradeSheetsArea ,#learnerCourseGradeSheetArea",
        ).addClass("hidden");
    ...
    $("#instructorCustomCheck").on("change", function (e) {
        ...
        if ($(this).is(":checked")) {
            ...
            $("#instructorCustomBdayCheck").on("change", function (e) {
                ...
                if ($(this).is(":checked")) {
                    $("#instructor_enabled_customBirthday").removeClass(
                        "hidden",
                    );
                } else {
    ...
    $("#selectedSession_userCategory").on("change", function (e) {
        ...
        $(
            "#learnerSelectedSessionArea , #instructorSelectedSessionArea",
        ).addClass("hidden");
    ...
    var debounceGetGradeApprovedCourse = _.debounce(
        getGradeApprovedCourses,
        300,
    ...
    var debounceGetlearnerCourseGradeApprovedCourse = _.debounce(
        getlearnerCourseGradeApprovedCourses,
        300,
    ); // 300ms debounce delay
