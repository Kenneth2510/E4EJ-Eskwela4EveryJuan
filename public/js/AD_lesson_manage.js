$(document).ready(function() {
    ...
    $('#editLessonBtn').on('click', function(e) {
        ...
        $.ajax ({
            type: "GET",
            url: "/admin/courseManage/content/"+ courseID +"/"+ syllabusID +"/lesson/json",
            dataType: 'json',
...
`;
        ...
        const url = "/admin/courseManage/content/"+ courseID +"/"+ syllabusID +"/lesson/title/"+ lessonID +"/store_file/"+ lesson_contentID;
    ...
    $('#confirmDelete').on('click', function(e) {
        ...
        const url = "/admin/courseManage/content/lesson/"+ lessonID +"/title/"+lessonContentID+"/delete";
...
$('#save_lesson_btn').on('click', function(e) {
    ...
    var url = "/admin/courseManage/content/" + courseID + "/" + syllabusID + "/lesson/title/" + lessonID;
...
$('#saveEditBtn').on('click', async function(e){
    ...
    $('#pictureUploadForm').on('submit', function(e){
        ...
        var formData = new FormData(this);
        const url = "/admin/courseManage/content/"+ courseID +"/"+ syllabusID +"/lesson/title/"+ lessonID +"/picture"
