    ...
    $('#confirmSaveQuizContentBtn').on('click', function (e) {
        ...
        if (temp_questionsData.length === 0) {
            alert("Please add at least one question to the Quiz");
                    ...
                    let valid = temp_questionsData.every(function (questionData) {
            return questionData.questionCount != null &&
                questionData.question_id != null &&
                questionData.syllabus_id != null &&
                questionData.topic_title != null &&
                questionData.course_id != null &&
        ...
        if (!valid) {
            alert("Some question data is missing. Please check your input.");
            return;
        }
