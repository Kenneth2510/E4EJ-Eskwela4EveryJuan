$(document).ready(function () {
    ...
    function displayLearnerQuizOutputData(quizLearnerOutputData) {
        ...
        for (let i = 0; i < quizLearnerOutputData.length; i++) {
            const learner_quiz_output_id =
                quizLearnerOutputData[i]["learner_quiz_output_id"];
                ...
                questionDataDisp += `
                    <div class="my-5 py-5 px-3 questionData ${check_answer_style} border-2 rounded-lg">
                        ...
                        ${check_answer}
                            ...
                            <p class="text-xl p-2 font-semibold">${question}</p>
                        </div>
        ...
        $("#nextPage").on("click", function () {
            if (
                currentPage <
                Math.ceil(quizLearnerOutputData.length / questionsPerPage)
            ) {
                currentPage++;
                displayQuestionsByPage(currentPage);
