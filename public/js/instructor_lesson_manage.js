$(document).ready(function() {
    ...
    $('#editLessonBtn').on('click', function(e) {
        ...
        var url = "/instructor/course/content/"+ courseID +"/"+ syllabusID +"/lesson/json";
...
`;
        ...
        const url = "/instructor/course/content/"+ courseID +"/"+ syllabusID +"/lesson/title/"+ lessonID +"/store_file/"+ lesson_contentID;
        ...
        $('#confirmDelete_lessonContentPicture').on('click', function(e) {
            ...
            const url = "/instructor/course/content/"+ courseID +"/"+ syllabusID +"/lesson/title/"+ lessonID +"/delete_file/"+ lesson_contentID;
            // console.log(url)
            $.ajax({
                type: "POST",
                url: url,
...
$('#save_lesson_btn').on('click', function(e) {
    ...
    var url = "/instructor/course/content/" + courseID + "/" + syllabusID + "/lesson/title/" + lessonID;
    ...
    $('#saveEditBtn').on('click', function(e){
        ...
        for (let i = 0; i < lessonData.length; i++) {
            ...
            if (!/^none\d+$/.test(row_lesson_content_data['lesson_content_id'])) {
                ...
                const url = "/instructor/course/content/"+courseID+"/"+syllabusID+"/lesson/title/"+ lessonID +"/save"
                // console.log(url)
                ...
                const url = "/instructor/course/content/"+courseID+"/"+syllabusID+"/lesson/title/"+ lessonID +"/save_add";
        ...
        if(loopCounter == lessonData.length) {
            const url = "/instructor/course/content/"+courseID+"/"+syllabusID+"/lesson/"+title/"+ lessonID +"/generate_pdf";
...
$('#saveEditBtn').on('click', async function(e){
    $('#loaderModal').removeClass('hidden');
    ...
    $('#pictureUploadForm').on('submit', function(e){
        ...
        var formData = new FormData(this);
        const url = "/instructor/course/content/"+ courseID +"/"+ syllabusID +"/lesson/title/"+ lessonID +"/picture"
