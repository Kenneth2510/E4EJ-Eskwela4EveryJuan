    ...
    function getLearnerQuizData() {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                durationVal =
                    response["learnerSyllabusProgressData"]["duration"];
    ...
    function displayLearnerQuizData(quizLearnerQuestions) {
        ...
        for (let i = 0; i < quizLearnerQuestions.length; i++) {
            const learner_quiz_output_id =
                quizLearnerQuestions[i]["learner_quiz_output_id"];
        ...
        function updateLearnerAnswer(questionCount, answer) {
            ...
            const learnerAnswer = quizLearnerAnswers.find(
        ...
        $("#nextPage").on("click", function () {
            if (
                currentPage <
                Math.ceil(quizLearnerQuestions.length / questionsPerPage)
            ) {
                currentPage++;
                displayQuestionsByPage(currentPage);
